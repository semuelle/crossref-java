...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Pub Id Type Type</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * 
 * <!-- end-model-doc -->
 * @see gov.nih.nlm.ncbi.jats1.Jats1Package#getPubIdTypeType()
 * @model extendedMetaData="name='pub-id-type_._1_._type'"
 * @generated
 */
public enum PubIdTypeType implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Pub Id Type Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final PubIdTypeType[] VALUES_ARRAY =
		new PubIdTypeType[] {
			ACCESSION,
			ARCHIVE,
			ARK,
	...
	/**
	 * A public read-only list of all the '<em><b>Pub Id Type Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<PubIdTypeType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Pub Id Type Type</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static PubIdTypeType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			PubIdTypeType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Pub Id Type Type</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static PubIdTypeType getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			PubIdTypeType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Pub Id Type Type</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static PubIdTypeType get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private PubIdTypeType(int value, String name, String literal) {
		this.value = value;
		this.name = name;
