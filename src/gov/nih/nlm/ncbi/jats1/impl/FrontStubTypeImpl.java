...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Front Stub Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getArticleId <em>Article Id</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getArticleVersion <em>Article Version</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getArticleVersionAlternatives <em>Article Version Alternatives</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getArticleCategories <em>Article Categories</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getTitleGroup <em>Title Group</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getContribGroup <em>Contrib Group</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getAff <em>Aff</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getAffAlternatives <em>Aff Alternatives</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getAuthorNotes <em>Author Notes</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getPubDateClass <em>Pub Date Class</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getPubDate <em>Pub Date</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getPubDateNotAvailable <em>Pub Date Not Available</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getVolume <em>Volume</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getVolumeId <em>Volume Id</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getVolumeSeries <em>Volume Series</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getIssue <em>Issue</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getIssueId <em>Issue Id</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getIssueTitle <em>Issue Title</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getIssueSponsor <em>Issue Sponsor</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getIssuePart <em>Issue Part</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getVolumeIssueGroup <em>Volume Issue Group</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getIsbn <em>Isbn</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getSupplement <em>Supplement</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getFpage <em>Fpage</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getLpage <em>Lpage</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getPageRange <em>Page Range</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getElocationId <em>Elocation Id</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getGroup1 <em>Group1</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getEmail <em>Email</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getExtLink <em>Ext Link</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getUri <em>Uri</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getProduct <em>Product</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getSupplementaryMaterial <em>Supplementary Material</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getHistory <em>History</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getPubHistory <em>Pub History</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getPermissions <em>Permissions</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getSelfUri <em>Self Uri</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getRelatedArticleClass <em>Related Article Class</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getRelatedArticle <em>Related Article</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getRelatedObject <em>Related Object</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getAbstractClass <em>Abstract Class</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getAbstract <em>Abstract</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getTransAbstract <em>Trans Abstract</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getKwdGroupClass <em>Kwd Group Class</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getKwdGroup <em>Kwd Group</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getFundingGroup <em>Funding Group</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getSupportGroup <em>Support Group</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getConference <em>Conference</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getCounts <em>Counts</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getCustomMetaGroup <em>Custom Meta Group</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getBase <em>Base</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.FrontStubTypeImpl#getId <em>Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FrontStubTypeImpl extends MinimalEObjectImpl.Container implements FrontStubType {
	/**
	...
	protected EClass eStaticClass() {
		return Jats1Package.eINSTANCE.getFrontStubType();
	}
	...
	public EList<ArticleIdType> getArticleId() {
		if (articleId == null) {
			articleId = new EObjectContainmentEList<ArticleIdType>(ArticleIdType.class, this, Jats1Package.FRONT_STUB_TYPE__ARTICLE_ID);
		}
		return articleId;
	}
	...
	public NotificationChain basicSetArticleVersion(ArticleVersionType newArticleVersion, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Jats1Package.FRONT_STUB_TYPE__ARTICLE_VERSION, oldArticleVersion, newArticleVersion);
	...
	public void setArticleVersion(ArticleVersionType newArticleVersion) {
		if (newArticleVersion != articleVersion) {
			...
			if (articleVersion != null)
				msgs = ((InternalEObject)articleVersion).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Jats1Package.FRONT_STUB_TYPE__ARTICLE_VERSION, null, msgs);
			if (newArticleVersion != null)
				msgs = ((InternalEObject)newArticleVersion).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Jats1Package.FRONT_STUB_TYPE__ARTICLE_VERSION, null, msgs);
			msgs = basicSetArticleVersion(newArticleVersion, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Jats1Package.FRONT_STUB_TYPE__ARTICLE_VERSION, newArticleVersion, newArticleVersion));
	}
	...
	public NotificationChain basicSetArticleVersionAlternatives(ArticleVersionAlternativesType newArticleVersionAlternatives, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Jats1Package.FRONT_STUB_TYPE__ARTICLE_VERSION_ALTERNATIVES, oldArticleVersionAlternatives, newArticleVersionAlternatives);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setArticleVersionAlternatives(ArticleVersionAlternativesType newArticleVersionAlternatives) {
		if (newArticleVersionAlternatives != articleVersionAlternatives) {
			...
			if (articleVersionAlternatives != null)
				msgs = ((InternalEObject)articleVersionAlternatives).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Jats1Package.FRONT_STUB_TYPE__ARTICLE_VERSION_ALTERNATIVES, null, msgs);
			if (newArticleVersionAlternatives != null)
				msgs = ((InternalEObject)newArticleVersionAlternatives).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Jats1Package.FRONT_STUB_TYPE__ARTICLE_VERSION_ALTERNATIVES, null, msgs);
			msgs = basicSetArticleVersionAlternatives(newArticleVersionAlternatives, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Jats1Package.FRONT_STUB_TYPE__ARTICLE_VERSION_ALTERNATIVES, newArticleVersionAlternatives, newArticleVersionAlternatives));
	}
	...
	public NotificationChain basicSetArticleCategories(ArticleCategoriesType newArticleCategories, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Jats1Package.FRONT_STUB_TYPE__ARTICLE_CATEGORIES, oldArticleCategories, newArticleCategories);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setArticleCategories(ArticleCategoriesType newArticleCategories) {
		if (newArticleCategories != articleCategories) {
			...
			if (articleCategories != null)
				msgs = ((InternalEObject)articleCategories).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Jats1Package.FRONT_STUB_TYPE__ARTICLE_CATEGORIES, null, msgs);
			if (newArticleCategories != null)
				msgs = ((InternalEObject)newArticleCategories).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Jats1Package.FRONT_STUB_TYPE__ARTICLE_CATEGORIES, null, msgs);
			msgs = basicSetArticleCategories(newArticleCategories, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Jats1Package.FRONT_STUB_TYPE__ARTICLE_CATEGORIES, newArticleCategories, newArticleCategories));
	}
	...
	public NotificationChain basicSetTitleGroup(TitleGroupType newTitleGroup, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Jats1Package.FRONT_STUB_TYPE__TITLE_GROUP, oldTitleGroup, newTitleGroup);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTitleGroup(TitleGroupType newTitleGroup) {
		if (newTitleGroup != titleGroup) {
			NotificationChain msgs = null;
			if (titleGroup != null)
				msgs = ((InternalEObject)titleGroup).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Jats1Package.FRONT_STUB_TYPE__TITLE_GROUP, null, msgs);
			if (newTitleGroup != null)
				msgs = ((InternalEObject)newTitleGroup).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Jats1Package.FRONT_STUB_TYPE__TITLE_GROUP, null, msgs);
			msgs = basicSetTitleGroup(newTitleGroup, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Jats1Package.FRONT_STUB_TYPE__TITLE_GROUP, newTitleGroup, newTitleGroup));
	}
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, Jats1Package.FRONT_STUB_TYPE__GROUP);
		}
		return group;
	}
	...
	public EList<ContribGroupType> getContribGroup() {
		return getGroup().list(Jats1Package.eINSTANCE.getFrontStubType_ContribGroup());
	}
	...
	public EList<AffType> getAff() {
		return getGroup().list(Jats1Package.eINSTANCE.getFrontStubType_Aff());
	}
	...
	public EList<AffAlternativesType> getAffAlternatives() {
		return getGroup().list(Jats1Package.eINSTANCE.getFrontStubType_AffAlternatives());
	}
	...
	public NotificationChain basicSetAuthorNotes(AuthorNotesType newAuthorNotes, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Jats1Package.FRONT_STUB_TYPE__AUTHOR_NOTES, oldAuthorNotes, newAuthorNotes);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAuthorNotes(AuthorNotesType newAuthorNotes) {
		if (newAuthorNotes != authorNotes) {
			NotificationChain msgs = null;
			if (authorNotes != null)
				msgs = ((InternalEObject)authorNotes).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Jats1Package.FRONT_STUB_TYPE__AUTHOR_NOTES, null, msgs);
			if (newAuthorNotes != null)
				msgs = ((InternalEObject)newAuthorNotes).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Jats1Package.FRONT_STUB_TYPE__AUTHOR_NOTES, null, msgs);
			msgs = basicSetAuthorNotes(newAuthorNotes, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Jats1Package.FRONT_STUB_TYPE__AUTHOR_NOTES, newAuthorNotes, newAuthorNotes));
	}
	...
	public FeatureMap getPubDateClass() {
		if (pubDateClass == null) {
			pubDateClass = new BasicFeatureMap(this, Jats1Package.FRONT_STUB_TYPE__PUB_DATE_CLASS);
		}
		return pubDateClass;
	}
	...
	public EList<PubDateType> getPubDate() {
		return getPubDateClass().list(Jats1Package.eINSTANCE.getFrontStubType_PubDate());
	}
	...
	public NotificationChain basicSetPubDateNotAvailable(PubDateNotAvailableType newPubDateNotAvailable, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Jats1Package.FRONT_STUB_TYPE__PUB_DATE_NOT_AVAILABLE, oldPubDateNotAvailable, newPubDateNotAvailable);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPubDateNotAvailable(PubDateNotAvailableType newPubDateNotAvailable) {
		if (newPubDateNotAvailable != pubDateNotAvailable) {
			...
			if (pubDateNotAvailable != null)
				msgs = ((InternalEObject)pubDateNotAvailable).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Jats1Package.FRONT_STUB_TYPE__PUB_DATE_NOT_AVAILABLE, null, msgs);
			if (newPubDateNotAvailable != null)
				msgs = ((InternalEObject)newPubDateNotAvailable).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Jats1Package.FRONT_STUB_TYPE__PUB_DATE_NOT_AVAILABLE, null, msgs);
			msgs = basicSetPubDateNotAvailable(newPubDateNotAvailable, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Jats1Package.FRONT_STUB_TYPE__PUB_DATE_NOT_AVAILABLE, newPubDateNotAvailable, newPubDateNotAvailable));
	}
	...
	public EList<VolumeType> getVolume() {
		if (volume == null) {
			volume = new EObjectContainmentEList<VolumeType>(VolumeType.class, this, Jats1Package.FRONT_STUB_TYPE__VOLUME);
		}
		return volume;
	}
	...
	public EList<VolumeIdType> getVolumeId() {
		if (volumeId == null) {
			volumeId = new EObjectContainmentEList<VolumeIdType>(VolumeIdType.class, this, Jats1Package.FRONT_STUB_TYPE__VOLUME_ID);
		}
		return volumeId;
	}
	...
	public NotificationChain basicSetVolumeSeries(VolumeSeriesType newVolumeSeries, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Jats1Package.FRONT_STUB_TYPE__VOLUME_SERIES, oldVolumeSeries, newVolumeSeries);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setVolumeSeries(VolumeSeriesType newVolumeSeries) {
		if (newVolumeSeries != volumeSeries) {
			...
			if (volumeSeries != null)
				msgs = ((InternalEObject)volumeSeries).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Jats1Package.FRONT_STUB_TYPE__VOLUME_SERIES, null, msgs);
			if (newVolumeSeries != null)
				msgs = ((InternalEObject)newVolumeSeries).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Jats1Package.FRONT_STUB_TYPE__VOLUME_SERIES, null, msgs);
			msgs = basicSetVolumeSeries(newVolumeSeries, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Jats1Package.FRONT_STUB_TYPE__VOLUME_SERIES, newVolumeSeries, newVolumeSeries));
	}
	...
	public EList<IssueType> getIssue() {
		if (issue == null) {
			issue = new EObjectContainmentEList<IssueType>(IssueType.class, this, Jats1Package.FRONT_STUB_TYPE__ISSUE);
		}
		return issue;
	}
	...
	public EList<IssueIdType> getIssueId() {
		if (issueId == null) {
			issueId = new EObjectContainmentEList<IssueIdType>(IssueIdType.class, this, Jats1Package.FRONT_STUB_TYPE__ISSUE_ID);
		}
		return issueId;
	}
	...
	public EList<IssueTitleType> getIssueTitle() {
		if (issueTitle == null) {
			issueTitle = new EObjectContainmentEList<IssueTitleType>(IssueTitleType.class, this, Jats1Package.FRONT_STUB_TYPE__ISSUE_TITLE);
		}
		return issueTitle;
	}
	...
	public EList<IssueSponsorType> getIssueSponsor() {
		if (issueSponsor == null) {
			issueSponsor = new EObjectContainmentEList<IssueSponsorType>(IssueSponsorType.class, this, Jats1Package.FRONT_STUB_TYPE__ISSUE_SPONSOR);
		}
		return issueSponsor;
	}
	...
	public NotificationChain basicSetIssuePart(IssuePartType newIssuePart, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Jats1Package.FRONT_STUB_TYPE__ISSUE_PART, oldIssuePart, newIssuePart);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIssuePart(IssuePartType newIssuePart) {
		if (newIssuePart != issuePart) {
			NotificationChain msgs = null;
			if (issuePart != null)
				msgs = ((InternalEObject)issuePart).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Jats1Package.FRONT_STUB_TYPE__ISSUE_PART, null, msgs);
			if (newIssuePart != null)
				msgs = ((InternalEObject)newIssuePart).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Jats1Package.FRONT_STUB_TYPE__ISSUE_PART, null, msgs);
			msgs = basicSetIssuePart(newIssuePart, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Jats1Package.FRONT_STUB_TYPE__ISSUE_PART, newIssuePart, newIssuePart));
	}
	...
	public EList<VolumeIssueGroupType> getVolumeIssueGroup() {
		if (volumeIssueGroup == null) {
			volumeIssueGroup = new EObjectContainmentEList<VolumeIssueGroupType>(VolumeIssueGroupType.class, this, Jats1Package.FRONT_STUB_TYPE__VOLUME_ISSUE_GROUP);
		}
	...
	public EList<IsbnType> getIsbn() {
		if (isbn == null) {
			isbn = new EObjectContainmentEList<IsbnType>(IsbnType.class, this, Jats1Package.FRONT_STUB_TYPE__ISBN);
		}
		return isbn;
	}
	...
	public NotificationChain basicSetSupplement(SupplementType newSupplement, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Jats1Package.FRONT_STUB_TYPE__SUPPLEMENT, oldSupplement, newSupplement);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSupplement(SupplementType newSupplement) {
		if (newSupplement != supplement) {
			NotificationChain msgs = null;
			if (supplement != null)
				msgs = ((InternalEObject)supplement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Jats1Package.FRONT_STUB_TYPE__SUPPLEMENT, null, msgs);
			if (newSupplement != null)
				msgs = ((InternalEObject)newSupplement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Jats1Package.FRONT_STUB_TYPE__SUPPLEMENT, null, msgs);
			msgs = basicSetSupplement(newSupplement, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Jats1Package.FRONT_STUB_TYPE__SUPPLEMENT, newSupplement, newSupplement));
	}
	...
	public NotificationChain basicSetFpage(FpageType newFpage, NotificationChain msgs) {
		...
		fpage = newFpage;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Jats1Package.FRONT_STUB_TYPE__FPAGE, oldFpage, newFpage);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setFpage(FpageType newFpage) {
		if (newFpage != fpage) {
			NotificationChain msgs = null;
			if (fpage != null)
				msgs = ((InternalEObject)fpage).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Jats1Package.FRONT_STUB_TYPE__FPAGE, null, msgs);
			if (newFpage != null)
				msgs = ((InternalEObject)newFpage).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Jats1Package.FRONT_STUB_TYPE__FPAGE, null, msgs);
			msgs = basicSetFpage(newFpage, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Jats1Package.FRONT_STUB_TYPE__FPAGE, newFpage, newFpage));
	}
	...
	public NotificationChain basicSetLpage(LpageType newLpage, NotificationChain msgs) {
		...
		lpage = newLpage;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Jats1Package.FRONT_STUB_TYPE__LPAGE, oldLpage, newLpage);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLpage(LpageType newLpage) {
		if (newLpage != lpage) {
			NotificationChain msgs = null;
			if (lpage != null)
				msgs = ((InternalEObject)lpage).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Jats1Package.FRONT_STUB_TYPE__LPAGE, null, msgs);
			if (newLpage != null)
				msgs = ((InternalEObject)newLpage).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Jats1Package.FRONT_STUB_TYPE__LPAGE, null, msgs);
			msgs = basicSetLpage(newLpage, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Jats1Package.FRONT_STUB_TYPE__LPAGE, newLpage, newLpage));
	}
	...
	public NotificationChain basicSetPageRange(PageRangeType newPageRange, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Jats1Package.FRONT_STUB_TYPE__PAGE_RANGE, oldPageRange, newPageRange);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPageRange(PageRangeType newPageRange) {
		if (newPageRange != pageRange) {
			NotificationChain msgs = null;
			if (pageRange != null)
				msgs = ((InternalEObject)pageRange).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Jats1Package.FRONT_STUB_TYPE__PAGE_RANGE, null, msgs);
			if (newPageRange != null)
				msgs = ((InternalEObject)newPageRange).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Jats1Package.FRONT_STUB_TYPE__PAGE_RANGE, null, msgs);
			msgs = basicSetPageRange(newPageRange, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Jats1Package.FRONT_STUB_TYPE__PAGE_RANGE, newPageRange, newPageRange));
	}
	...
	public NotificationChain basicSetElocationId(ElocationIdType newElocationId, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Jats1Package.FRONT_STUB_TYPE__ELOCATION_ID, oldElocationId, newElocationId);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setElocationId(ElocationIdType newElocationId) {
		if (newElocationId != elocationId) {
			NotificationChain msgs = null;
			if (elocationId != null)
				msgs = ((InternalEObject)elocationId).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Jats1Package.FRONT_STUB_TYPE__ELOCATION_ID, null, msgs);
			if (newElocationId != null)
				msgs = ((InternalEObject)newElocationId).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Jats1Package.FRONT_STUB_TYPE__ELOCATION_ID, null, msgs);
			msgs = basicSetElocationId(newElocationId, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Jats1Package.FRONT_STUB_TYPE__ELOCATION_ID, newElocationId, newElocationId));
	}
	...
	public FeatureMap getGroup1() {
		if (group1 == null) {
			group1 = new BasicFeatureMap(this, Jats1Package.FRONT_STUB_TYPE__GROUP1);
		}
		return group1;
	}
	...
	public EList<EmailType> getEmail() {
		return getGroup1().list(Jats1Package.eINSTANCE.getFrontStubType_Email());
	}
	...
	public EList<ExtLinkType> getExtLink() {
		return getGroup1().list(Jats1Package.eINSTANCE.getFrontStubType_ExtLink());
	}
	...
	public EList<UriType> getUri() {
		return getGroup1().list(Jats1Package.eINSTANCE.getFrontStubType_Uri());
	}
	...
	public EList<ProductType> getProduct() {
		return getGroup1().list(Jats1Package.eINSTANCE.getFrontStubType_Product());
	}
	...
	public EList<SupplementaryMaterialType> getSupplementaryMaterial() {
		return getGroup1().list(Jats1Package.eINSTANCE.getFrontStubType_SupplementaryMaterial());
	}
	...
	public NotificationChain basicSetHistory(HistoryType newHistory, NotificationChain msgs) {
		...
		history = newHistory;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Jats1Package.FRONT_STUB_TYPE__HISTORY, oldHistory, newHistory);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setHistory(HistoryType newHistory) {
		if (newHistory != history) {
			NotificationChain msgs = null;
			if (history != null)
				msgs = ((InternalEObject)history).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Jats1Package.FRONT_STUB_TYPE__HISTORY, null, msgs);
			if (newHistory != null)
				msgs = ((InternalEObject)newHistory).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Jats1Package.FRONT_STUB_TYPE__HISTORY, null, msgs);
			msgs = basicSetHistory(newHistory, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Jats1Package.FRONT_STUB_TYPE__HISTORY, newHistory, newHistory));
	}
	...
	public NotificationChain basicSetPubHistory(PubHistoryType newPubHistory, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Jats1Package.FRONT_STUB_TYPE__PUB_HISTORY, oldPubHistory, newPubHistory);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPubHistory(PubHistoryType newPubHistory) {
		if (newPubHistory != pubHistory) {
			NotificationChain msgs = null;
			if (pubHistory != null)
				msgs = ((InternalEObject)pubHistory).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Jats1Package.FRONT_STUB_TYPE__PUB_HISTORY, null, msgs);
			if (newPubHistory != null)
				msgs = ((InternalEObject)newPubHistory).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Jats1Package.FRONT_STUB_TYPE__PUB_HISTORY, null, msgs);
			msgs = basicSetPubHistory(newPubHistory, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Jats1Package.FRONT_STUB_TYPE__PUB_HISTORY, newPubHistory, newPubHistory));
	}
	...
	public NotificationChain basicSetPermissions(PermissionsType newPermissions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Jats1Package.FRONT_STUB_TYPE__PERMISSIONS, oldPermissions, newPermissions);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPermissions(PermissionsType newPermissions) {
		if (newPermissions != permissions) {
			NotificationChain msgs = null;
			if (permissions != null)
				msgs = ((InternalEObject)permissions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Jats1Package.FRONT_STUB_TYPE__PERMISSIONS, null, msgs);
			if (newPermissions != null)
				msgs = ((InternalEObject)newPermissions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Jats1Package.FRONT_STUB_TYPE__PERMISSIONS, null, msgs);
			msgs = basicSetPermissions(newPermissions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Jats1Package.FRONT_STUB_TYPE__PERMISSIONS, newPermissions, newPermissions));
	}
	...
	public EList<SelfUriType> getSelfUri() {
		if (selfUri == null) {
			selfUri = new EObjectContainmentEList<SelfUriType>(SelfUriType.class, this, Jats1Package.FRONT_STUB_TYPE__SELF_URI);
		}
		return selfUri;
	}
	...
	public FeatureMap getRelatedArticleClass() {
		if (relatedArticleClass == null) {
			relatedArticleClass = new BasicFeatureMap(this, Jats1Package.FRONT_STUB_TYPE__RELATED_ARTICLE_CLASS);
		}
	...
	public EList<RelatedArticleType> getRelatedArticle() {
		return getRelatedArticleClass().list(Jats1Package.eINSTANCE.getFrontStubType_RelatedArticle());
	}
	...
	public EList<RelatedObjectType> getRelatedObject() {
		return getRelatedArticleClass().list(Jats1Package.eINSTANCE.getFrontStubType_RelatedObject());
	}
	...
	public FeatureMap getAbstractClass() {
		if (abstractClass == null) {
			abstractClass = new BasicFeatureMap(this, Jats1Package.FRONT_STUB_TYPE__ABSTRACT_CLASS);
		}
	...
	public EList<AbstractType> getAbstract() {
		return getAbstractClass().list(Jats1Package.eINSTANCE.getFrontStubType_Abstract());
	}
	...
	public EList<TransAbstractType> getTransAbstract() {
		if (transAbstract == null) {
			transAbstract = new EObjectContainmentEList<TransAbstractType>(TransAbstractType.class, this, Jats1Package.FRONT_STUB_TYPE__TRANS_ABSTRACT);
		}
	...
	public FeatureMap getKwdGroupClass() {
		if (kwdGroupClass == null) {
			kwdGroupClass = new BasicFeatureMap(this, Jats1Package.FRONT_STUB_TYPE__KWD_GROUP_CLASS);
		}
	...
	public EList<KwdGroupType> getKwdGroup() {
		return getKwdGroupClass().list(Jats1Package.eINSTANCE.getFrontStubType_KwdGroup());
	}
	...
	public EList<FundingGroupType> getFundingGroup() {
		if (fundingGroup == null) {
			fundingGroup = new EObjectContainmentEList<FundingGroupType>(FundingGroupType.class, this, Jats1Package.FRONT_STUB_TYPE__FUNDING_GROUP);
		}
		return fundingGroup;
	}
	...
	public EList<SupportGroupType> getSupportGroup() {
		if (supportGroup == null) {
			supportGroup = new EObjectContainmentEList<SupportGroupType>(SupportGroupType.class, this, Jats1Package.FRONT_STUB_TYPE__SUPPORT_GROUP);
		}
		return supportGroup;
	}
	...
	public EList<ConferenceType> getConference() {
		if (conference == null) {
			conference = new EObjectContainmentEList<ConferenceType>(ConferenceType.class, this, Jats1Package.FRONT_STUB_TYPE__CONFERENCE);
		}
		return conference;
	}
	...
	public NotificationChain basicSetCounts(CountsType newCounts, NotificationChain msgs) {
		...
		counts = newCounts;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Jats1Package.FRONT_STUB_TYPE__COUNTS, oldCounts, newCounts);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setCounts(CountsType newCounts) {
		if (newCounts != counts) {
			NotificationChain msgs = null;
			if (counts != null)
				msgs = ((InternalEObject)counts).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Jats1Package.FRONT_STUB_TYPE__COUNTS, null, msgs);
			if (newCounts != null)
				msgs = ((InternalEObject)newCounts).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Jats1Package.FRONT_STUB_TYPE__COUNTS, null, msgs);
			msgs = basicSetCounts(newCounts, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Jats1Package.FRONT_STUB_TYPE__COUNTS, newCounts, newCounts));
	}
	...
	public NotificationChain basicSetCustomMetaGroup(CustomMetaGroupType newCustomMetaGroup, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Jats1Package.FRONT_STUB_TYPE__CUSTOM_META_GROUP, oldCustomMetaGroup, newCustomMetaGroup);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setCustomMetaGroup(CustomMetaGroupType newCustomMetaGroup) {
		if (newCustomMetaGroup != customMetaGroup) {
			...
			if (customMetaGroup != null)
				msgs = ((InternalEObject)customMetaGroup).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Jats1Package.FRONT_STUB_TYPE__CUSTOM_META_GROUP, null, msgs);
			if (newCustomMetaGroup != null)
				msgs = ((InternalEObject)newCustomMetaGroup).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Jats1Package.FRONT_STUB_TYPE__CUSTOM_META_GROUP, null, msgs);
			msgs = basicSetCustomMetaGroup(newCustomMetaGroup, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Jats1Package.FRONT_STUB_TYPE__CUSTOM_META_GROUP, newCustomMetaGroup, newCustomMetaGroup));
	}
	...
	public void setBase(String newBase) {
		...
		base = newBase;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Jats1Package.FRONT_STUB_TYPE__BASE, oldBase, base));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Jats1Package.FRONT_STUB_TYPE__ID, oldId, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Jats1Package.FRONT_STUB_TYPE__BASE:
				return getBase();
			case Jats1Package.FRONT_STUB_TYPE__ID:
				return getId();
		}
