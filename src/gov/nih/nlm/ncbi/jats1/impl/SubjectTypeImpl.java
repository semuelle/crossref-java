 ...
 * </p>
 * <ul>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.SubjectTypeImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.SubjectTypeImpl#getSubjectElements <em>Subject Elements</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.SubjectTypeImpl#getBold <em>Bold</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.SubjectTypeImpl#getFixedCase <em>Fixed Case</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.SubjectTypeImpl#getItalic <em>Italic</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.SubjectTypeImpl#getMonospace <em>Monospace</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.SubjectTypeImpl#getOverline <em>Overline</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.SubjectTypeImpl#getRoman <em>Roman</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.SubjectTypeImpl#getSansSerif <em>Sans Serif</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.SubjectTypeImpl#getSc <em>Sc</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.SubjectTypeImpl#getStrike <em>Strike</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.SubjectTypeImpl#getUnderline <em>Underline</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.SubjectTypeImpl#getRuby <em>Ruby</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.SubjectTypeImpl#getAlternatives <em>Alternatives</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.SubjectTypeImpl#getInlineGraphic <em>Inline Graphic</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.SubjectTypeImpl#getInlineMedia <em>Inline Media</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.SubjectTypeImpl#getPrivateChar <em>Private Char</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.SubjectTypeImpl#getChemStruct <em>Chem Struct</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.SubjectTypeImpl#getInlineFormula <em>Inline Formula</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.SubjectTypeImpl#getNamedContent <em>Named Content</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.SubjectTypeImpl#getStyledContent <em>Styled Content</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.SubjectTypeImpl#getSub <em>Sub</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.SubjectTypeImpl#getSup <em>Sup</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.SubjectTypeImpl#getBase <em>Base</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.SubjectTypeImpl#getContentType <em>Content Type</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.SubjectTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.SubjectTypeImpl#getVocab <em>Vocab</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.SubjectTypeImpl#getVocabIdentifier <em>Vocab Identifier</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.SubjectTypeImpl#getVocabTerm <em>Vocab Term</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.SubjectTypeImpl#getVocabTermIdentifier <em>Vocab Term Identifier</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SubjectTypeImpl extends MinimalEObjectImpl.Container implements SubjectType {
	...
	protected EClass eStaticClass() {
		return Jats1Package.eINSTANCE.getSubjectType();
	}
	...
	public FeatureMap getMixed() {
		if (mixed == null) {
			mixed = new BasicFeatureMap(this, Jats1Package.SUBJECT_TYPE__MIXED);
		}
		return mixed;
	}
	 ...
	 */
	@Override
	public FeatureMap getSubjectElements() {
		return (FeatureMap)getMixed().<FeatureMap.Entry>list(Jats1Package.eINSTANCE.getSubjectType_SubjectElements());
	}
	...
	public EList<BoldType> getBold() {
		return getSubjectElements().list(Jats1Package.eINSTANCE.getSubjectType_Bold());
	}
	...
	public EList<FixedCaseType> getFixedCase() {
		return getSubjectElements().list(Jats1Package.eINSTANCE.getSubjectType_FixedCase());
	}
	...
	public EList<ItalicType> getItalic() {
		return getSubjectElements().list(Jats1Package.eINSTANCE.getSubjectType_Italic());
	}
	...
	public EList<MonospaceType> getMonospace() {
		return getSubjectElements().list(Jats1Package.eINSTANCE.getSubjectType_Monospace());
	}
	...
	public EList<OverlineType> getOverline() {
		return getSubjectElements().list(Jats1Package.eINSTANCE.getSubjectType_Overline());
	}
	...
	public EList<RomanType> getRoman() {
		return getSubjectElements().list(Jats1Package.eINSTANCE.getSubjectType_Roman());
	}
	...
	public EList<SansSerifType> getSansSerif() {
		return getSubjectElements().list(Jats1Package.eINSTANCE.getSubjectType_SansSerif());
	}
	...
	public EList<ScType> getSc() {
		return getSubjectElements().list(Jats1Package.eINSTANCE.getSubjectType_Sc());
	}
	...
	public EList<StrikeType> getStrike() {
		return getSubjectElements().list(Jats1Package.eINSTANCE.getSubjectType_Strike());
	}
	...
	public EList<UnderlineType> getUnderline() {
		return getSubjectElements().list(Jats1Package.eINSTANCE.getSubjectType_Underline());
	}
	...
	public EList<RubyType> getRuby() {
		return getSubjectElements().list(Jats1Package.eINSTANCE.getSubjectType_Ruby());
	}
	...
	public EList<AlternativesType> getAlternatives() {
		return getSubjectElements().list(Jats1Package.eINSTANCE.getSubjectType_Alternatives());
	}
	...
	public EList<InlineGraphicType> getInlineGraphic() {
		return getSubjectElements().list(Jats1Package.eINSTANCE.getSubjectType_InlineGraphic());
	}
	...
	public EList<InlineMediaType> getInlineMedia() {
		return getSubjectElements().list(Jats1Package.eINSTANCE.getSubjectType_InlineMedia());
	}
	...
	public EList<PrivateCharType> getPrivateChar() {
		return getSubjectElements().list(Jats1Package.eINSTANCE.getSubjectType_PrivateChar());
	}
	...
	public EList<ChemStructType> getChemStruct() {
		return getSubjectElements().list(Jats1Package.eINSTANCE.getSubjectType_ChemStruct());
	}
	...
	public EList<InlineFormulaType> getInlineFormula() {
		return getSubjectElements().list(Jats1Package.eINSTANCE.getSubjectType_InlineFormula());
	}
	...
	public EList<NamedContentType> getNamedContent() {
		return getSubjectElements().list(Jats1Package.eINSTANCE.getSubjectType_NamedContent());
	}
	...
	public EList<StyledContentType> getStyledContent() {
		return getSubjectElements().list(Jats1Package.eINSTANCE.getSubjectType_StyledContent());
	}
	...
	public EList<SubType> getSub() {
		return getSubjectElements().list(Jats1Package.eINSTANCE.getSubjectType_Sub());
	}
	...
	public EList<SupType> getSup() {
		return getSubjectElements().list(Jats1Package.eINSTANCE.getSubjectType_Sup());
	}
	...
	public void setBase(String newBase) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Jats1Package.SUBJECT_TYPE__BASE, oldBase, base));
	}
	...
	public void setContentType(String newContentType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Jats1Package.SUBJECT_TYPE__CONTENT_TYPE, oldContentType, contentType));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Jats1Package.SUBJECT_TYPE__ID, oldId, id));
	}
	...
	public void setVocab(String newVocab) {
		...
		vocab = newVocab;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Jats1Package.SUBJECT_TYPE__VOCAB, oldVocab, vocab));
	}
	...
	public void setVocabIdentifier(String newVocabIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Jats1Package.SUBJECT_TYPE__VOCAB_IDENTIFIER, oldVocabIdentifier, vocabIdentifier));
	}
	...
	public void setVocabTerm(String newVocabTerm) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Jats1Package.SUBJECT_TYPE__VOCAB_TERM, oldVocabTerm, vocabTerm));
	}
	...
	public void setVocabTermIdentifier(String newVocabTermIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Jats1Package.SUBJECT_TYPE__VOCAB_TERM_IDENTIFIER, oldVocabTermIdentifier, vocabTermIdentifier));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Jats1Package.SUBJECT_TYPE__SUBJECT_ELEMENTS:
				if (coreType) return getSubjectElements();
				return ((FeatureMap.Internal)getSubjectElements()).getWrapper();
			case Jats1Package.SUBJECT_TYPE__BOLD:
				return getBold();
			case Jats1Package.SUBJECT_TYPE__FIXED_CASE:
				return getFixedCase();
			...
			case Jats1Package.SUBJECT_TYPE__SUP:
				return getSup();
			case Jats1Package.SUBJECT_TYPE__BASE:
				return getBase();
			case Jats1Package.SUBJECT_TYPE__CONTENT_TYPE:
				return getContentType();
			case Jats1Package.SUBJECT_TYPE__ID:
				return getId();
			case Jats1Package.SUBJECT_TYPE__VOCAB:
				return getVocab();
			case Jats1Package.SUBJECT_TYPE__VOCAB_IDENTIFIER:
				return getVocabIdentifier();
			case Jats1Package.SUBJECT_TYPE__VOCAB_TERM:
				return getVocabTerm();
			case Jats1Package.SUBJECT_TYPE__VOCAB_TERM_IDENTIFIER:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case Jats1Package.SUBJECT_TYPE__MIXED:
				...
				return;
			case Jats1Package.SUBJECT_TYPE__SUBJECT_ELEMENTS:
				((FeatureMap.Internal)getSubjectElements()).set(newValue);
				return;
			case Jats1Package.SUBJECT_TYPE__BOLD:
				getBold().clear();
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case Jats1Package.SUBJECT_TYPE__SUBJECT_ELEMENTS:
				return !getSubjectElements().isEmpty();
			case Jats1Package.SUBJECT_TYPE__BOLD:
