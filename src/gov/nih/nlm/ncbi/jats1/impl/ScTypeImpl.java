...
import gov.nih.nlm.ncbi.jats1.ToggleType6;
 ...
 * </p>
 * <ul>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.ScTypeImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.ScTypeImpl#getEmphasizedText <em>Emphasized Text</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.ScTypeImpl#getEmail <em>Email</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.ScTypeImpl#getExtLink <em>Ext Link</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.ScTypeImpl#getUri <em>Uri</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.ScTypeImpl#getInlineSupplementaryMaterial <em>Inline Supplementary Material</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.ScTypeImpl#getRelatedArticle <em>Related Article</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.ScTypeImpl#getRelatedObject <em>Related Object</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.ScTypeImpl#getBold <em>Bold</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.ScTypeImpl#getFixedCase <em>Fixed Case</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.ScTypeImpl#getItalic <em>Italic</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.ScTypeImpl#getMonospace <em>Monospace</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.ScTypeImpl#getOverline <em>Overline</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.ScTypeImpl#getRoman <em>Roman</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.ScTypeImpl#getSansSerif <em>Sans Serif</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.ScTypeImpl#getSc <em>Sc</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.ScTypeImpl#getStrike <em>Strike</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.ScTypeImpl#getUnderline <em>Underline</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.ScTypeImpl#getRuby <em>Ruby</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.ScTypeImpl#getAlternatives <em>Alternatives</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.ScTypeImpl#getInlineGraphic <em>Inline Graphic</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.ScTypeImpl#getInlineMedia <em>Inline Media</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.ScTypeImpl#getPrivateChar <em>Private Char</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.ScTypeImpl#getChemStruct <em>Chem Struct</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.ScTypeImpl#getInlineFormula <em>Inline Formula</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.ScTypeImpl#getTexMath <em>Tex Math</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.ScTypeImpl#getMath <em>Math</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.ScTypeImpl#getAbbrev <em>Abbrev</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.ScTypeImpl#getIndexTerm <em>Index Term</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.ScTypeImpl#getIndexTermRangeEnd <em>Index Term Range End</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.ScTypeImpl#getMilestoneEnd <em>Milestone End</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.ScTypeImpl#getMilestoneStart <em>Milestone Start</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.ScTypeImpl#getNamedContent <em>Named Content</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.ScTypeImpl#getStyledContent <em>Styled Content</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.ScTypeImpl#getFn <em>Fn</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.ScTypeImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.ScTypeImpl#getXref <em>Xref</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.ScTypeImpl#getSub <em>Sub</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.ScTypeImpl#getSup <em>Sup</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.ScTypeImpl#getBase <em>Base</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.ScTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.ScTypeImpl#getSpecificUse <em>Specific Use</em>}</li>
 *   <li>{@link gov.nih.nlm.ncbi.jats1.impl.ScTypeImpl#getToggle <em>Toggle</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ScTypeImpl extends MinimalEObjectImpl.Container implements ScType {
	/**
	 ...
	 * @ordered
	 */
	protected static final ToggleType6 TOGGLE_EDEFAULT = ToggleType6.NO;
	 ...
	 * @ordered
	 */
	protected ToggleType6 toggle = TOGGLE_EDEFAULT;
	...
	protected EClass eStaticClass() {
		return Jats1Package.eINSTANCE.getScType();
	}
	...
	public FeatureMap getMixed() {
		if (mixed == null) {
			mixed = new BasicFeatureMap(this, Jats1Package.SC_TYPE__MIXED);
		}
		return mixed;
	}
	...
	public FeatureMap getEmphasizedText() {
		return (FeatureMap)getMixed().<FeatureMap.Entry>list(Jats1Package.eINSTANCE.getScType_EmphasizedText());
	}
	...
	public EList<EmailType> getEmail() {
		return getEmphasizedText().list(Jats1Package.eINSTANCE.getScType_Email());
	}
	...
	public EList<ExtLinkType> getExtLink() {
		return getEmphasizedText().list(Jats1Package.eINSTANCE.getScType_ExtLink());
	}
	...
	public EList<UriType> getUri() {
		return getEmphasizedText().list(Jats1Package.eINSTANCE.getScType_Uri());
	}
	...
	public EList<InlineSupplementaryMaterialType> getInlineSupplementaryMaterial() {
		return getEmphasizedText().list(Jats1Package.eINSTANCE.getScType_InlineSupplementaryMaterial());
	}
	...
	public EList<RelatedArticleType> getRelatedArticle() {
		return getEmphasizedText().list(Jats1Package.eINSTANCE.getScType_RelatedArticle());
	}
	...
	public EList<RelatedObjectType> getRelatedObject() {
		return getEmphasizedText().list(Jats1Package.eINSTANCE.getScType_RelatedObject());
	}
	...
	public EList<BoldType> getBold() {
		return getEmphasizedText().list(Jats1Package.eINSTANCE.getScType_Bold());
	}
	...
	public EList<FixedCaseType> getFixedCase() {
		return getEmphasizedText().list(Jats1Package.eINSTANCE.getScType_FixedCase());
	}
	...
	public EList<ItalicType> getItalic() {
		return getEmphasizedText().list(Jats1Package.eINSTANCE.getScType_Italic());
	}
	...
	public EList<MonospaceType> getMonospace() {
		return getEmphasizedText().list(Jats1Package.eINSTANCE.getScType_Monospace());
	}
	...
	public EList<OverlineType> getOverline() {
		return getEmphasizedText().list(Jats1Package.eINSTANCE.getScType_Overline());
	}
	...
	public EList<RomanType> getRoman() {
		return getEmphasizedText().list(Jats1Package.eINSTANCE.getScType_Roman());
	}
	...
	public EList<SansSerifType> getSansSerif() {
		return getEmphasizedText().list(Jats1Package.eINSTANCE.getScType_SansSerif());
	}
	...
	public EList<ScType> getSc() {
		return getEmphasizedText().list(Jats1Package.eINSTANCE.getScType_Sc());
	}
	...
	public EList<StrikeType> getStrike() {
		return getEmphasizedText().list(Jats1Package.eINSTANCE.getScType_Strike());
	}
	...
	public EList<UnderlineType> getUnderline() {
		return getEmphasizedText().list(Jats1Package.eINSTANCE.getScType_Underline());
	}
	...
	public EList<RubyType> getRuby() {
		return getEmphasizedText().list(Jats1Package.eINSTANCE.getScType_Ruby());
	}
	...
	public EList<AlternativesType> getAlternatives() {
		return getEmphasizedText().list(Jats1Package.eINSTANCE.getScType_Alternatives());
	}
	...
	public EList<InlineGraphicType> getInlineGraphic() {
		return getEmphasizedText().list(Jats1Package.eINSTANCE.getScType_InlineGraphic());
	}
	...
	public EList<InlineMediaType> getInlineMedia() {
		return getEmphasizedText().list(Jats1Package.eINSTANCE.getScType_InlineMedia());
	}
	...
	public EList<PrivateCharType> getPrivateChar() {
		return getEmphasizedText().list(Jats1Package.eINSTANCE.getScType_PrivateChar());
	}
	...
	public EList<ChemStructType> getChemStruct() {
		return getEmphasizedText().list(Jats1Package.eINSTANCE.getScType_ChemStruct());
	}
	...
	public EList<InlineFormulaType> getInlineFormula() {
		return getEmphasizedText().list(Jats1Package.eINSTANCE.getScType_InlineFormula());
	}
	...
	public EList<TexMathType> getTexMath() {
		return getEmphasizedText().list(Jats1Package.eINSTANCE.getScType_TexMath());
	}
	...
	public EList<MathType> getMath() {
		return getEmphasizedText().list(Jats1Package.eINSTANCE.getScType_Math());
	}
	...
	public EList<AbbrevType> getAbbrev() {
		return getEmphasizedText().list(Jats1Package.eINSTANCE.getScType_Abbrev());
	}
	...
	public EList<IndexTermType> getIndexTerm() {
		return getEmphasizedText().list(Jats1Package.eINSTANCE.getScType_IndexTerm());
	}
	...
	public EList<IndexTermRangeEndType> getIndexTermRangeEnd() {
		return getEmphasizedText().list(Jats1Package.eINSTANCE.getScType_IndexTermRangeEnd());
	}
	...
	public EList<MilestoneEndType> getMilestoneEnd() {
		return getEmphasizedText().list(Jats1Package.eINSTANCE.getScType_MilestoneEnd());
	}
	...
	public EList<MilestoneStartType> getMilestoneStart() {
		return getEmphasizedText().list(Jats1Package.eINSTANCE.getScType_MilestoneStart());
	}
	...
	public EList<NamedContentType> getNamedContent() {
		return getEmphasizedText().list(Jats1Package.eINSTANCE.getScType_NamedContent());
	}
	...
	public EList<StyledContentType> getStyledContent() {
		return getEmphasizedText().list(Jats1Package.eINSTANCE.getScType_StyledContent());
	}
	...
	public EList<FnType> getFn() {
		return getEmphasizedText().list(Jats1Package.eINSTANCE.getScType_Fn());
	}
	...
	public EList<TargetType> getTarget() {
		return getEmphasizedText().list(Jats1Package.eINSTANCE.getScType_Target());
	}
	...
	public EList<XrefType> getXref() {
		return getEmphasizedText().list(Jats1Package.eINSTANCE.getScType_Xref());
	}
	...
	public EList<SubType> getSub() {
		return getEmphasizedText().list(Jats1Package.eINSTANCE.getScType_Sub());
	}
	...
	public EList<SupType> getSup() {
		return getEmphasizedText().list(Jats1Package.eINSTANCE.getScType_Sup());
	}
	...
	public void setBase(String newBase) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Jats1Package.SC_TYPE__BASE, oldBase, base));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Jats1Package.SC_TYPE__ID, oldId, id));
	}
	...
	public void setSpecificUse(String newSpecificUse) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Jats1Package.SC_TYPE__SPECIFIC_USE, oldSpecificUse, specificUse));
	}
	 ...
	 */
	@Override
	public void setToggle(ToggleType6 newToggle) {
		ToggleType6 oldToggle = toggle;
		toggle = newToggle == null ? TOGGLE_EDEFAULT : newToggle;
		boolean oldToggleESet = toggleESet;
		toggleESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Jats1Package.SC_TYPE__TOGGLE, oldToggle, toggle, !oldToggleESet));
	}
	...
	public void unsetToggle() {
		...
		toggleESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Jats1Package.SC_TYPE__TOGGLE, oldToggle, TOGGLE_EDEFAULT, oldToggleESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Jats1Package.SC_TYPE__SUP:
				return getSup();
			case Jats1Package.SC_TYPE__BASE:
				return getBase();
			case Jats1Package.SC_TYPE__ID:
				return getId();
			case Jats1Package.SC_TYPE__SPECIFIC_USE:
				return getSpecificUse();
			case Jats1Package.SC_TYPE__TOGGLE:
				return getToggle();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case Jats1Package.SC_TYPE__SPECIFIC_USE:
				...
				return;
			case Jats1Package.SC_TYPE__TOGGLE:
				setToggle((ToggleType6)newValue);
				return;
		}
