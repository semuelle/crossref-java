 ...
 * </p>
 * <ul>
 *   <li>{@link org.niso.schemas.ali._1._0.impl.FreeToReadTypeImpl#getEndDate <em>End Date</em>}</li>
 *   <li>{@link org.niso.schemas.ali._1._0.impl.FreeToReadTypeImpl#getStartDate <em>Start Date</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FreeToReadTypeImpl extends MinimalEObjectImpl.Container implements FreeToReadType {
	...
	protected EClass eStaticClass() {
		return _0Package.Literals.FREE_TO_READ_TYPE;
	}
	...
	public void setEndDate(XMLGregorianCalendar newEndDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.FREE_TO_READ_TYPE__END_DATE, oldEndDate, endDate));
	}
	...
	public void setStartDate(XMLGregorianCalendar newStartDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.FREE_TO_READ_TYPE__START_DATE, oldStartDate, startDate));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _0Package.FREE_TO_READ_TYPE__END_DATE:
				return getEndDate();
			case _0Package.FREE_TO_READ_TYPE__START_DATE:
				return getStartDate();
		}
