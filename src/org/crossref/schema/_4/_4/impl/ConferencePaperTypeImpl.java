...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Conference Paper Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.crossref.schema._4._4.impl.ConferencePaperTypeImpl#getContributors <em>Contributors</em>}</li>
 *   <li>{@link org.crossref.schema._4._4.impl.ConferencePaperTypeImpl#getTitles <em>Titles</em>}</li>
 *   <li>{@link org.crossref.schema._4._4.impl.ConferencePaperTypeImpl#getAbstract <em>Abstract</em>}</li>
 *   <li>{@link org.crossref.schema._4._4.impl.ConferencePaperTypeImpl#getPublicationDate <em>Publication Date</em>}</li>
 *   <li>{@link org.crossref.schema._4._4.impl.ConferencePaperTypeImpl#getAcceptanceDate <em>Acceptance Date</em>}</li>
 *   <li>{@link org.crossref.schema._4._4.impl.ConferencePaperTypeImpl#getPages <em>Pages</em>}</li>
 *   <li>{@link org.crossref.schema._4._4.impl.ConferencePaperTypeImpl#getPublisherItem <em>Publisher Item</em>}</li>
 *   <li>{@link org.crossref.schema._4._4.impl.ConferencePaperTypeImpl#getCrossmark <em>Crossmark</em>}</li>
 *   <li>{@link org.crossref.schema._4._4.impl.ConferencePaperTypeImpl#getProgram <em>Program</em>}</li>
 *   <li>{@link org.crossref.schema._4._4.impl.ConferencePaperTypeImpl#getProgram1 <em>Program1</em>}</li>
 *   <li>{@link org.crossref.schema._4._4.impl.ConferencePaperTypeImpl#getProgram2 <em>Program2</em>}</li>
 *   <li>{@link org.crossref.schema._4._4.impl.ConferencePaperTypeImpl#getProgram3 <em>Program3</em>}</li>
 *   <li>{@link org.crossref.schema._4._4.impl.ConferencePaperTypeImpl#getArchiveLocations <em>Archive Locations</em>}</li>
 *   <li>{@link org.crossref.schema._4._4.impl.ConferencePaperTypeImpl#getScnPolicies <em>Scn Policies</em>}</li>
 *   <li>{@link org.crossref.schema._4._4.impl.ConferencePaperTypeImpl#getDoiData <em>Doi Data</em>}</li>
 *   <li>{@link org.crossref.schema._4._4.impl.ConferencePaperTypeImpl#getCitationList <em>Citation List</em>}</li>
 *   <li>{@link org.crossref.schema._4._4.impl.ConferencePaperTypeImpl#getComponentList <em>Component List</em>}</li>
 *   <li>{@link org.crossref.schema._4._4.impl.ConferencePaperTypeImpl#getLanguage <em>Language</em>}</li>
 *   <li>{@link org.crossref.schema._4._4.impl.ConferencePaperTypeImpl#getPublicationType <em>Publication Type</em>}</li>
 *   <li>{@link org.crossref.schema._4._4.impl.ConferencePaperTypeImpl#getReferenceDistributionOpts <em>Reference Distribution Opts</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConferencePaperTypeImpl extends MinimalEObjectImpl.Container implements ConferencePaperType {
	/**
	 ...
	 * @generated
	 */
	protected ConferencePaperTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return _4Package.eINSTANCE.getConferencePaperType();
	}
	...
	public NotificationChain basicSetContributors(ContributorsType newContributors, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _4Package.CONFERENCE_PAPER_TYPE__CONTRIBUTORS, oldContributors, newContributors);
	...
	public void setContributors(ContributorsType newContributors) {
		if (newContributors != contributors) {
			...
			if (contributors != null)
				msgs = ((InternalEObject)contributors).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _4Package.CONFERENCE_PAPER_TYPE__CONTRIBUTORS, null, msgs);
			if (newContributors != null)
				msgs = ((InternalEObject)newContributors).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _4Package.CONFERENCE_PAPER_TYPE__CONTRIBUTORS, null, msgs);
			msgs = basicSetContributors(newContributors, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _4Package.CONFERENCE_PAPER_TYPE__CONTRIBUTORS, newContributors, newContributors));
	}
	...
	public NotificationChain basicSetTitles(TitlesType newTitles, NotificationChain msgs) {
		...
		titles = newTitles;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _4Package.CONFERENCE_PAPER_TYPE__TITLES, oldTitles, newTitles);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTitles(TitlesType newTitles) {
		if (newTitles != titles) {
			NotificationChain msgs = null;
			if (titles != null)
				msgs = ((InternalEObject)titles).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _4Package.CONFERENCE_PAPER_TYPE__TITLES, null, msgs);
			if (newTitles != null)
				msgs = ((InternalEObject)newTitles).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _4Package.CONFERENCE_PAPER_TYPE__TITLES, null, msgs);
			msgs = basicSetTitles(newTitles, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _4Package.CONFERENCE_PAPER_TYPE__TITLES, newTitles, newTitles));
	}
	...
	public EList<AbstractType> getAbstract() {
		if (abstract_ == null) {
			abstract_ = new EObjectContainmentEList<AbstractType>(AbstractType.class, this, _4Package.CONFERENCE_PAPER_TYPE__ABSTRACT);
		}
		return abstract_;
	}
	...
	public EList<PublicationDateType> getPublicationDate() {
		if (publicationDate == null) {
			publicationDate = new EObjectContainmentEList<PublicationDateType>(PublicationDateType.class, this, _4Package.CONFERENCE_PAPER_TYPE__PUBLICATION_DATE);
		}
	...
	public NotificationChain basicSetAcceptanceDate(AcceptanceDateType newAcceptanceDate, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _4Package.CONFERENCE_PAPER_TYPE__ACCEPTANCE_DATE, oldAcceptanceDate, newAcceptanceDate);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAcceptanceDate(AcceptanceDateType newAcceptanceDate) {
		if (newAcceptanceDate != acceptanceDate) {
			...
			if (acceptanceDate != null)
				msgs = ((InternalEObject)acceptanceDate).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _4Package.CONFERENCE_PAPER_TYPE__ACCEPTANCE_DATE, null, msgs);
			if (newAcceptanceDate != null)
				msgs = ((InternalEObject)newAcceptanceDate).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _4Package.CONFERENCE_PAPER_TYPE__ACCEPTANCE_DATE, null, msgs);
			msgs = basicSetAcceptanceDate(newAcceptanceDate, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _4Package.CONFERENCE_PAPER_TYPE__ACCEPTANCE_DATE, newAcceptanceDate, newAcceptanceDate));
	}
	...
	public NotificationChain basicSetPages(PagesType newPages, NotificationChain msgs) {
		...
		pages = newPages;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _4Package.CONFERENCE_PAPER_TYPE__PAGES, oldPages, newPages);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPages(PagesType newPages) {
		if (newPages != pages) {
			NotificationChain msgs = null;
			if (pages != null)
				msgs = ((InternalEObject)pages).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _4Package.CONFERENCE_PAPER_TYPE__PAGES, null, msgs);
			if (newPages != null)
				msgs = ((InternalEObject)newPages).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _4Package.CONFERENCE_PAPER_TYPE__PAGES, null, msgs);
			msgs = basicSetPages(newPages, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _4Package.CONFERENCE_PAPER_TYPE__PAGES, newPages, newPages));
	}
	...
	public NotificationChain basicSetPublisherItem(PublisherItemType newPublisherItem, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _4Package.CONFERENCE_PAPER_TYPE__PUBLISHER_ITEM, oldPublisherItem, newPublisherItem);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPublisherItem(PublisherItemType newPublisherItem) {
		if (newPublisherItem != publisherItem) {
			...
			if (publisherItem != null)
				msgs = ((InternalEObject)publisherItem).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _4Package.CONFERENCE_PAPER_TYPE__PUBLISHER_ITEM, null, msgs);
			if (newPublisherItem != null)
				msgs = ((InternalEObject)newPublisherItem).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _4Package.CONFERENCE_PAPER_TYPE__PUBLISHER_ITEM, null, msgs);
			msgs = basicSetPublisherItem(newPublisherItem, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _4Package.CONFERENCE_PAPER_TYPE__PUBLISHER_ITEM, newPublisherItem, newPublisherItem));
	}
	...
	public NotificationChain basicSetCrossmark(CrossmarkType newCrossmark, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _4Package.CONFERENCE_PAPER_TYPE__CROSSMARK, oldCrossmark, newCrossmark);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setCrossmark(CrossmarkType newCrossmark) {
		if (newCrossmark != crossmark) {
			NotificationChain msgs = null;
			if (crossmark != null)
				msgs = ((InternalEObject)crossmark).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _4Package.CONFERENCE_PAPER_TYPE__CROSSMARK, null, msgs);
			if (newCrossmark != null)
				msgs = ((InternalEObject)newCrossmark).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _4Package.CONFERENCE_PAPER_TYPE__CROSSMARK, null, msgs);
			msgs = basicSetCrossmark(newCrossmark, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _4Package.CONFERENCE_PAPER_TYPE__CROSSMARK, newCrossmark, newCrossmark));
	}
	...
	public NotificationChain basicSetProgram(ProgramType newProgram, NotificationChain msgs) {
		...
		program = newProgram;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _4Package.CONFERENCE_PAPER_TYPE__PROGRAM, oldProgram, newProgram);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setProgram(ProgramType newProgram) {
		if (newProgram != program) {
			NotificationChain msgs = null;
			if (program != null)
				msgs = ((InternalEObject)program).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _4Package.CONFERENCE_PAPER_TYPE__PROGRAM, null, msgs);
			if (newProgram != null)
				msgs = ((InternalEObject)newProgram).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _4Package.CONFERENCE_PAPER_TYPE__PROGRAM, null, msgs);
			msgs = basicSetProgram(newProgram, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _4Package.CONFERENCE_PAPER_TYPE__PROGRAM, newProgram, newProgram));
	}
	...
	public NotificationChain basicSetProgram1(org.crossref.access.indicators.ProgramType newProgram1, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _4Package.CONFERENCE_PAPER_TYPE__PROGRAM1, oldProgram1, newProgram1);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setProgram1(org.crossref.access.indicators.ProgramType newProgram1) {
		if (newProgram1 != program1) {
			NotificationChain msgs = null;
			if (program1 != null)
				msgs = ((InternalEObject)program1).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _4Package.CONFERENCE_PAPER_TYPE__PROGRAM1, null, msgs);
			if (newProgram1 != null)
				msgs = ((InternalEObject)newProgram1).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _4Package.CONFERENCE_PAPER_TYPE__PROGRAM1, null, msgs);
			msgs = basicSetProgram1(newProgram1, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _4Package.CONFERENCE_PAPER_TYPE__PROGRAM1, newProgram1, newProgram1));
	}
	...
	public NotificationChain basicSetProgram2(org.crossref.clinicaltrials.ProgramType newProgram2, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _4Package.CONFERENCE_PAPER_TYPE__PROGRAM2, oldProgram2, newProgram2);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setProgram2(org.crossref.clinicaltrials.ProgramType newProgram2) {
		if (newProgram2 != program2) {
			NotificationChain msgs = null;
			if (program2 != null)
				msgs = ((InternalEObject)program2).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _4Package.CONFERENCE_PAPER_TYPE__PROGRAM2, null, msgs);
			if (newProgram2 != null)
				msgs = ((InternalEObject)newProgram2).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _4Package.CONFERENCE_PAPER_TYPE__PROGRAM2, null, msgs);
			msgs = basicSetProgram2(newProgram2, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _4Package.CONFERENCE_PAPER_TYPE__PROGRAM2, newProgram2, newProgram2));
	}
	...
	public NotificationChain basicSetProgram3(org.crossref.relations.ProgramType newProgram3, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _4Package.CONFERENCE_PAPER_TYPE__PROGRAM3, oldProgram3, newProgram3);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setProgram3(org.crossref.relations.ProgramType newProgram3) {
		if (newProgram3 != program3) {
			NotificationChain msgs = null;
			if (program3 != null)
				msgs = ((InternalEObject)program3).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _4Package.CONFERENCE_PAPER_TYPE__PROGRAM3, null, msgs);
			if (newProgram3 != null)
				msgs = ((InternalEObject)newProgram3).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _4Package.CONFERENCE_PAPER_TYPE__PROGRAM3, null, msgs);
			msgs = basicSetProgram3(newProgram3, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _4Package.CONFERENCE_PAPER_TYPE__PROGRAM3, newProgram3, newProgram3));
	}
	...
	public NotificationChain basicSetArchiveLocations(ArchiveLocationsType newArchiveLocations, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _4Package.CONFERENCE_PAPER_TYPE__ARCHIVE_LOCATIONS, oldArchiveLocations, newArchiveLocations);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setArchiveLocations(ArchiveLocationsType newArchiveLocations) {
		if (newArchiveLocations != archiveLocations) {
			...
			if (archiveLocations != null)
				msgs = ((InternalEObject)archiveLocations).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _4Package.CONFERENCE_PAPER_TYPE__ARCHIVE_LOCATIONS, null, msgs);
			if (newArchiveLocations != null)
				msgs = ((InternalEObject)newArchiveLocations).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _4Package.CONFERENCE_PAPER_TYPE__ARCHIVE_LOCATIONS, null, msgs);
			msgs = basicSetArchiveLocations(newArchiveLocations, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _4Package.CONFERENCE_PAPER_TYPE__ARCHIVE_LOCATIONS, newArchiveLocations, newArchiveLocations));
	}
	...
	public NotificationChain basicSetScnPolicies(ScnPoliciesType newScnPolicies, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _4Package.CONFERENCE_PAPER_TYPE__SCN_POLICIES, oldScnPolicies, newScnPolicies);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setScnPolicies(ScnPoliciesType newScnPolicies) {
		if (newScnPolicies != scnPolicies) {
			NotificationChain msgs = null;
			if (scnPolicies != null)
				msgs = ((InternalEObject)scnPolicies).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _4Package.CONFERENCE_PAPER_TYPE__SCN_POLICIES, null, msgs);
			if (newScnPolicies != null)
				msgs = ((InternalEObject)newScnPolicies).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _4Package.CONFERENCE_PAPER_TYPE__SCN_POLICIES, null, msgs);
			msgs = basicSetScnPolicies(newScnPolicies, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _4Package.CONFERENCE_PAPER_TYPE__SCN_POLICIES, newScnPolicies, newScnPolicies));
	}
	...
	public NotificationChain basicSetDoiData(DoiDataType newDoiData, NotificationChain msgs) {
		...
		doiData = newDoiData;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _4Package.CONFERENCE_PAPER_TYPE__DOI_DATA, oldDoiData, newDoiData);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDoiData(DoiDataType newDoiData) {
		if (newDoiData != doiData) {
			NotificationChain msgs = null;
			if (doiData != null)
				msgs = ((InternalEObject)doiData).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _4Package.CONFERENCE_PAPER_TYPE__DOI_DATA, null, msgs);
			if (newDoiData != null)
				msgs = ((InternalEObject)newDoiData).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _4Package.CONFERENCE_PAPER_TYPE__DOI_DATA, null, msgs);
			msgs = basicSetDoiData(newDoiData, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _4Package.CONFERENCE_PAPER_TYPE__DOI_DATA, newDoiData, newDoiData));
	}
	...
	public NotificationChain basicSetCitationList(CitationListType newCitationList, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _4Package.CONFERENCE_PAPER_TYPE__CITATION_LIST, oldCitationList, newCitationList);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setCitationList(CitationListType newCitationList) {
		if (newCitationList != citationList) {
			...
			if (citationList != null)
				msgs = ((InternalEObject)citationList).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _4Package.CONFERENCE_PAPER_TYPE__CITATION_LIST, null, msgs);
			if (newCitationList != null)
				msgs = ((InternalEObject)newCitationList).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _4Package.CONFERENCE_PAPER_TYPE__CITATION_LIST, null, msgs);
			msgs = basicSetCitationList(newCitationList, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _4Package.CONFERENCE_PAPER_TYPE__CITATION_LIST, newCitationList, newCitationList));
	}
	...
	public NotificationChain basicSetComponentList(ComponentListType newComponentList, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _4Package.CONFERENCE_PAPER_TYPE__COMPONENT_LIST, oldComponentList, newComponentList);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setComponentList(ComponentListType newComponentList) {
		if (newComponentList != componentList) {
			...
			if (componentList != null)
				msgs = ((InternalEObject)componentList).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _4Package.CONFERENCE_PAPER_TYPE__COMPONENT_LIST, null, msgs);
			if (newComponentList != null)
				msgs = ((InternalEObject)newComponentList).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _4Package.CONFERENCE_PAPER_TYPE__COMPONENT_LIST, null, msgs);
			msgs = basicSetComponentList(newComponentList, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _4Package.CONFERENCE_PAPER_TYPE__COMPONENT_LIST, newComponentList, newComponentList));
	}
	...
	public void setLanguage(LanguageType newLanguage) {
		...
		languageESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _4Package.CONFERENCE_PAPER_TYPE__LANGUAGE, oldLanguage, language, !oldLanguageESet));
	}
	...
	public void unsetLanguage() {
		...
		languageESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _4Package.CONFERENCE_PAPER_TYPE__LANGUAGE, oldLanguage, LANGUAGE_EDEFAULT, oldLanguageESet));
	}
	...
	public void setPublicationType(PublicationTypeType newPublicationType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _4Package.CONFERENCE_PAPER_TYPE__PUBLICATION_TYPE, oldPublicationType, publicationType, !oldPublicationTypeESet));
	}
	...
	public void unsetPublicationType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _4Package.CONFERENCE_PAPER_TYPE__PUBLICATION_TYPE, oldPublicationType, PUBLICATION_TYPE_EDEFAULT, oldPublicationTypeESet));
	}
	...
	public void setReferenceDistributionOpts(ReferenceDistributionOptsType newReferenceDistributionOpts) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _4Package.CONFERENCE_PAPER_TYPE__REFERENCE_DISTRIBUTION_OPTS, oldReferenceDistributionOpts, referenceDistributionOpts, !oldReferenceDistributionOptsESet));
	}
	...
	public void unsetReferenceDistributionOpts() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _4Package.CONFERENCE_PAPER_TYPE__REFERENCE_DISTRIBUTION_OPTS, oldReferenceDistributionOpts, REFERENCE_DISTRIBUTION_OPTS_EDEFAULT, oldReferenceDistributionOptsESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _4Package.CONFERENCE_PAPER_TYPE__CONTRIBUTORS:
				return basicSetContributors(null, msgs);
			case _4Package.CONFERENCE_PAPER_TYPE__TITLES:
				return basicSetTitles(null, msgs);
			case _4Package.CONFERENCE_PAPER_TYPE__ABSTRACT:
				return ((InternalEList<?>)getAbstract()).basicRemove(otherEnd, msgs);
			case _4Package.CONFERENCE_PAPER_TYPE__PUBLICATION_DATE:
				return ((InternalEList<?>)getPublicationDate()).basicRemove(otherEnd, msgs);
			case _4Package.CONFERENCE_PAPER_TYPE__ACCEPTANCE_DATE:
				return basicSetAcceptanceDate(null, msgs);
			case _4Package.CONFERENCE_PAPER_TYPE__PAGES:
				return basicSetPages(null, msgs);
			case _4Package.CONFERENCE_PAPER_TYPE__PUBLISHER_ITEM:
				return basicSetPublisherItem(null, msgs);
			case _4Package.CONFERENCE_PAPER_TYPE__CROSSMARK:
				return basicSetCrossmark(null, msgs);
			case _4Package.CONFERENCE_PAPER_TYPE__PROGRAM:
				return basicSetProgram(null, msgs);
			case _4Package.CONFERENCE_PAPER_TYPE__PROGRAM1:
				return basicSetProgram1(null, msgs);
			case _4Package.CONFERENCE_PAPER_TYPE__PROGRAM2:
				return basicSetProgram2(null, msgs);
			case _4Package.CONFERENCE_PAPER_TYPE__PROGRAM3:
				return basicSetProgram3(null, msgs);
			case _4Package.CONFERENCE_PAPER_TYPE__ARCHIVE_LOCATIONS:
				return basicSetArchiveLocations(null, msgs);
			case _4Package.CONFERENCE_PAPER_TYPE__SCN_POLICIES:
				return basicSetScnPolicies(null, msgs);
			case _4Package.CONFERENCE_PAPER_TYPE__DOI_DATA:
				return basicSetDoiData(null, msgs);
			case _4Package.CONFERENCE_PAPER_TYPE__CITATION_LIST:
				return basicSetCitationList(null, msgs);
			case _4Package.CONFERENCE_PAPER_TYPE__COMPONENT_LIST:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case _4Package.CONFERENCE_PAPER_TYPE__LANGUAGE:
				return getLanguage();
			case _4Package.CONFERENCE_PAPER_TYPE__PUBLICATION_TYPE:
				return getPublicationType();
			case _4Package.CONFERENCE_PAPER_TYPE__REFERENCE_DISTRIBUTION_OPTS:
