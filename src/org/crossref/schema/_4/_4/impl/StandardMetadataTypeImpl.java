...
import org.crossref.schema._4._4.PublicationStatusType;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Standard Metadata Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.crossref.schema._4._4.impl.StandardMetadataTypeImpl#getContributors <em>Contributors</em>}</li>
 *   <li>{@link org.crossref.schema._4._4.impl.StandardMetadataTypeImpl#getTitles <em>Titles</em>}</li>
 *   <li>{@link org.crossref.schema._4._4.impl.StandardMetadataTypeImpl#getAbstract <em>Abstract</em>}</li>
 *   <li>{@link org.crossref.schema._4._4.impl.StandardMetadataTypeImpl#getDesignators <em>Designators</em>}</li>
 *   <li>{@link org.crossref.schema._4._4.impl.StandardMetadataTypeImpl#getEditionNumber <em>Edition Number</em>}</li>
 *   <li>{@link org.crossref.schema._4._4.impl.StandardMetadataTypeImpl#getApprovalDate <em>Approval Date</em>}</li>
 *   <li>{@link org.crossref.schema._4._4.impl.StandardMetadataTypeImpl#getIsbn <em>Isbn</em>}</li>
 *   <li>{@link org.crossref.schema._4._4.impl.StandardMetadataTypeImpl#getPublisher <em>Publisher</em>}</li>
 *   <li>{@link org.crossref.schema._4._4.impl.StandardMetadataTypeImpl#getStandardsBody <em>Standards Body</em>}</li>
 *   <li>{@link org.crossref.schema._4._4.impl.StandardMetadataTypeImpl#getPublisherItem <em>Publisher Item</em>}</li>
 *   <li>{@link org.crossref.schema._4._4.impl.StandardMetadataTypeImpl#getCrossmark <em>Crossmark</em>}</li>
 *   <li>{@link org.crossref.schema._4._4.impl.StandardMetadataTypeImpl#getProgram <em>Program</em>}</li>
 *   <li>{@link org.crossref.schema._4._4.impl.StandardMetadataTypeImpl#getProgram1 <em>Program1</em>}</li>
 *   <li>{@link org.crossref.schema._4._4.impl.StandardMetadataTypeImpl#getProgram2 <em>Program2</em>}</li>
 *   <li>{@link org.crossref.schema._4._4.impl.StandardMetadataTypeImpl#getArchiveLocations <em>Archive Locations</em>}</li>
 *   <li>{@link org.crossref.schema._4._4.impl.StandardMetadataTypeImpl#getDoiData <em>Doi Data</em>}</li>
 *   <li>{@link org.crossref.schema._4._4.impl.StandardMetadataTypeImpl#getCitationList <em>Citation List</em>}</li>
 *   <li>{@link org.crossref.schema._4._4.impl.StandardMetadataTypeImpl#getLanguage <em>Language</em>}</li>
 *   <li>{@link org.crossref.schema._4._4.impl.StandardMetadataTypeImpl#getPublicationStatus <em>Publication Status</em>}</li>
 *   <li>{@link org.crossref.schema._4._4.impl.StandardMetadataTypeImpl#getReferenceDistributionOpts <em>Reference Distribution Opts</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StandardMetadataTypeImpl extends MinimalEObjectImpl.Container implements StandardMetadataType {
	/**
	...
	/**
	 * The cached value of the '{@link #getDesignators() <em>Designators</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getDesignators()
	 * @generated
	 * @ordered
	 */
	protected DesignatorsType designators;
	 ...
	 * @ordered
	 */
	protected static final PublicationStatusType PUBLICATION_STATUS_EDEFAULT = PublicationStatusType.RELEASED;
	 ...
	 * @generated
	 */
	protected StandardMetadataTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return _4Package.eINSTANCE.getStandardMetadataType();
	}
	...
	public NotificationChain basicSetContributors(ContributorsType newContributors, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _4Package.STANDARD_METADATA_TYPE__CONTRIBUTORS, oldContributors, newContributors);
	...
	public void setContributors(ContributorsType newContributors) {
		if (newContributors != contributors) {
			...
			if (contributors != null)
				msgs = ((InternalEObject)contributors).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _4Package.STANDARD_METADATA_TYPE__CONTRIBUTORS, null, msgs);
			if (newContributors != null)
				msgs = ((InternalEObject)newContributors).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _4Package.STANDARD_METADATA_TYPE__CONTRIBUTORS, null, msgs);
			msgs = basicSetContributors(newContributors, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _4Package.STANDARD_METADATA_TYPE__CONTRIBUTORS, newContributors, newContributors));
	}
	...
	public NotificationChain basicSetTitles(TitlesType newTitles, NotificationChain msgs) {
		...
		titles = newTitles;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _4Package.STANDARD_METADATA_TYPE__TITLES, oldTitles, newTitles);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTitles(TitlesType newTitles) {
		if (newTitles != titles) {
			NotificationChain msgs = null;
			if (titles != null)
				msgs = ((InternalEObject)titles).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _4Package.STANDARD_METADATA_TYPE__TITLES, null, msgs);
			if (newTitles != null)
				msgs = ((InternalEObject)newTitles).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _4Package.STANDARD_METADATA_TYPE__TITLES, null, msgs);
			msgs = basicSetTitles(newTitles, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _4Package.STANDARD_METADATA_TYPE__TITLES, newTitles, newTitles));
	}
	...
	public EList<AbstractType> getAbstract() {
		if (abstract_ == null) {
			abstract_ = new EObjectContainmentEList<AbstractType>(AbstractType.class, this, _4Package.STANDARD_METADATA_TYPE__ABSTRACT);
		}
		return abstract_;
	}
	...
	public NotificationChain basicSetDesignators(DesignatorsType newDesignators, NotificationChain msgs) {
		DesignatorsType oldDesignators = designators;
		designators = newDesignators;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _4Package.STANDARD_METADATA_TYPE__DESIGNATORS, oldDesignators, newDesignators);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDesignators(DesignatorsType newDesignators) {
		if (newDesignators != designators) {
			NotificationChain msgs = null;
			if (designators != null)
				msgs = ((InternalEObject)designators).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _4Package.STANDARD_METADATA_TYPE__DESIGNATORS, null, msgs);
			if (newDesignators != null)
				msgs = ((InternalEObject)newDesignators).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _4Package.STANDARD_METADATA_TYPE__DESIGNATORS, null, msgs);
			msgs = basicSetDesignators(newDesignators, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _4Package.STANDARD_METADATA_TYPE__DESIGNATORS, newDesignators, newDesignators));
	}
	...
	public void setEditionNumber(String newEditionNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _4Package.STANDARD_METADATA_TYPE__EDITION_NUMBER, oldEditionNumber, editionNumber));
	}
	...
	public NotificationChain basicSetApprovalDate(ApprovalDateType newApprovalDate, NotificationChain msgs) {
		ApprovalDateType oldApprovalDate = approvalDate;
		approvalDate = newApprovalDate;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _4Package.STANDARD_METADATA_TYPE__APPROVAL_DATE, oldApprovalDate, newApprovalDate);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setApprovalDate(ApprovalDateType newApprovalDate) {
		if (newApprovalDate != approvalDate) {
			...
			if (approvalDate != null)
				msgs = ((InternalEObject)approvalDate).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _4Package.STANDARD_METADATA_TYPE__APPROVAL_DATE, null, msgs);
			if (newApprovalDate != null)
				msgs = ((InternalEObject)newApprovalDate).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _4Package.STANDARD_METADATA_TYPE__APPROVAL_DATE, null, msgs);
			msgs = basicSetApprovalDate(newApprovalDate, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _4Package.STANDARD_METADATA_TYPE__APPROVAL_DATE, newApprovalDate, newApprovalDate));
	}
	...
	public EList<IsbnType> getIsbn() {
		if (isbn == null) {
			isbn = new EObjectContainmentEList<IsbnType>(IsbnType.class, this, _4Package.STANDARD_METADATA_TYPE__ISBN);
		}
		return isbn;
	}
	...
	public NotificationChain basicSetPublisher(PublisherType newPublisher, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _4Package.STANDARD_METADATA_TYPE__PUBLISHER, oldPublisher, newPublisher);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPublisher(PublisherType newPublisher) {
		if (newPublisher != publisher) {
			NotificationChain msgs = null;
			if (publisher != null)
				msgs = ((InternalEObject)publisher).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _4Package.STANDARD_METADATA_TYPE__PUBLISHER, null, msgs);
			if (newPublisher != null)
				msgs = ((InternalEObject)newPublisher).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _4Package.STANDARD_METADATA_TYPE__PUBLISHER, null, msgs);
			msgs = basicSetPublisher(newPublisher, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _4Package.STANDARD_METADATA_TYPE__PUBLISHER, newPublisher, newPublisher));
	}
	...
	public NotificationChain basicSetStandardsBody(StandardsBodyType newStandardsBody, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _4Package.STANDARD_METADATA_TYPE__STANDARDS_BODY, oldStandardsBody, newStandardsBody);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setStandardsBody(StandardsBodyType newStandardsBody) {
		if (newStandardsBody != standardsBody) {
			...
			if (standardsBody != null)
				msgs = ((InternalEObject)standardsBody).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _4Package.STANDARD_METADATA_TYPE__STANDARDS_BODY, null, msgs);
			if (newStandardsBody != null)
				msgs = ((InternalEObject)newStandardsBody).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _4Package.STANDARD_METADATA_TYPE__STANDARDS_BODY, null, msgs);
			msgs = basicSetStandardsBody(newStandardsBody, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _4Package.STANDARD_METADATA_TYPE__STANDARDS_BODY, newStandardsBody, newStandardsBody));
	}
	...
	public NotificationChain basicSetPublisherItem(PublisherItemType newPublisherItem, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _4Package.STANDARD_METADATA_TYPE__PUBLISHER_ITEM, oldPublisherItem, newPublisherItem);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPublisherItem(PublisherItemType newPublisherItem) {
		if (newPublisherItem != publisherItem) {
			...
			if (publisherItem != null)
				msgs = ((InternalEObject)publisherItem).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _4Package.STANDARD_METADATA_TYPE__PUBLISHER_ITEM, null, msgs);
			if (newPublisherItem != null)
				msgs = ((InternalEObject)newPublisherItem).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _4Package.STANDARD_METADATA_TYPE__PUBLISHER_ITEM, null, msgs);
			msgs = basicSetPublisherItem(newPublisherItem, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _4Package.STANDARD_METADATA_TYPE__PUBLISHER_ITEM, newPublisherItem, newPublisherItem));
	}
	...
	public NotificationChain basicSetCrossmark(CrossmarkType newCrossmark, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _4Package.STANDARD_METADATA_TYPE__CROSSMARK, oldCrossmark, newCrossmark);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setCrossmark(CrossmarkType newCrossmark) {
		if (newCrossmark != crossmark) {
			NotificationChain msgs = null;
			if (crossmark != null)
				msgs = ((InternalEObject)crossmark).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _4Package.STANDARD_METADATA_TYPE__CROSSMARK, null, msgs);
			if (newCrossmark != null)
				msgs = ((InternalEObject)newCrossmark).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _4Package.STANDARD_METADATA_TYPE__CROSSMARK, null, msgs);
			msgs = basicSetCrossmark(newCrossmark, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _4Package.STANDARD_METADATA_TYPE__CROSSMARK, newCrossmark, newCrossmark));
	}
	...
	public NotificationChain basicSetProgram(ProgramType newProgram, NotificationChain msgs) {
		...
		program = newProgram;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _4Package.STANDARD_METADATA_TYPE__PROGRAM, oldProgram, newProgram);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setProgram(ProgramType newProgram) {
		if (newProgram != program) {
			NotificationChain msgs = null;
			if (program != null)
				msgs = ((InternalEObject)program).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _4Package.STANDARD_METADATA_TYPE__PROGRAM, null, msgs);
			if (newProgram != null)
				msgs = ((InternalEObject)newProgram).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _4Package.STANDARD_METADATA_TYPE__PROGRAM, null, msgs);
			msgs = basicSetProgram(newProgram, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _4Package.STANDARD_METADATA_TYPE__PROGRAM, newProgram, newProgram));
	}
	...
	public NotificationChain basicSetProgram1(org.crossref.access.indicators.ProgramType newProgram1, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _4Package.STANDARD_METADATA_TYPE__PROGRAM1, oldProgram1, newProgram1);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setProgram1(org.crossref.access.indicators.ProgramType newProgram1) {
		if (newProgram1 != program1) {
			NotificationChain msgs = null;
			if (program1 != null)
				msgs = ((InternalEObject)program1).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _4Package.STANDARD_METADATA_TYPE__PROGRAM1, null, msgs);
			if (newProgram1 != null)
				msgs = ((InternalEObject)newProgram1).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _4Package.STANDARD_METADATA_TYPE__PROGRAM1, null, msgs);
			msgs = basicSetProgram1(newProgram1, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _4Package.STANDARD_METADATA_TYPE__PROGRAM1, newProgram1, newProgram1));
	}
	...
	public NotificationChain basicSetProgram2(org.crossref.relations.ProgramType newProgram2, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _4Package.STANDARD_METADATA_TYPE__PROGRAM2, oldProgram2, newProgram2);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setProgram2(org.crossref.relations.ProgramType newProgram2) {
		if (newProgram2 != program2) {
			NotificationChain msgs = null;
			if (program2 != null)
				msgs = ((InternalEObject)program2).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _4Package.STANDARD_METADATA_TYPE__PROGRAM2, null, msgs);
			if (newProgram2 != null)
				msgs = ((InternalEObject)newProgram2).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _4Package.STANDARD_METADATA_TYPE__PROGRAM2, null, msgs);
			msgs = basicSetProgram2(newProgram2, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _4Package.STANDARD_METADATA_TYPE__PROGRAM2, newProgram2, newProgram2));
	}
	...
	public NotificationChain basicSetArchiveLocations(ArchiveLocationsType newArchiveLocations, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _4Package.STANDARD_METADATA_TYPE__ARCHIVE_LOCATIONS, oldArchiveLocations, newArchiveLocations);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setArchiveLocations(ArchiveLocationsType newArchiveLocations) {
		if (newArchiveLocations != archiveLocations) {
			...
			if (archiveLocations != null)
				msgs = ((InternalEObject)archiveLocations).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _4Package.STANDARD_METADATA_TYPE__ARCHIVE_LOCATIONS, null, msgs);
			if (newArchiveLocations != null)
				msgs = ((InternalEObject)newArchiveLocations).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _4Package.STANDARD_METADATA_TYPE__ARCHIVE_LOCATIONS, null, msgs);
			msgs = basicSetArchiveLocations(newArchiveLocations, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _4Package.STANDARD_METADATA_TYPE__ARCHIVE_LOCATIONS, newArchiveLocations, newArchiveLocations));
	}
	...
	public NotificationChain basicSetDoiData(DoiDataType newDoiData, NotificationChain msgs) {
		...
		doiData = newDoiData;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _4Package.STANDARD_METADATA_TYPE__DOI_DATA, oldDoiData, newDoiData);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDoiData(DoiDataType newDoiData) {
		if (newDoiData != doiData) {
			NotificationChain msgs = null;
			if (doiData != null)
				msgs = ((InternalEObject)doiData).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _4Package.STANDARD_METADATA_TYPE__DOI_DATA, null, msgs);
			if (newDoiData != null)
				msgs = ((InternalEObject)newDoiData).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _4Package.STANDARD_METADATA_TYPE__DOI_DATA, null, msgs);
			msgs = basicSetDoiData(newDoiData, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _4Package.STANDARD_METADATA_TYPE__DOI_DATA, newDoiData, newDoiData));
	}
	...
	public NotificationChain basicSetCitationList(CitationListType newCitationList, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _4Package.STANDARD_METADATA_TYPE__CITATION_LIST, oldCitationList, newCitationList);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setCitationList(CitationListType newCitationList) {
		if (newCitationList != citationList) {
			...
			if (citationList != null)
				msgs = ((InternalEObject)citationList).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _4Package.STANDARD_METADATA_TYPE__CITATION_LIST, null, msgs);
			if (newCitationList != null)
				msgs = ((InternalEObject)newCitationList).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _4Package.STANDARD_METADATA_TYPE__CITATION_LIST, null, msgs);
			msgs = basicSetCitationList(newCitationList, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _4Package.STANDARD_METADATA_TYPE__CITATION_LIST, newCitationList, newCitationList));
	}
	...
	public void setLanguage(LanguageType newLanguage) {
		...
		languageESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _4Package.STANDARD_METADATA_TYPE__LANGUAGE, oldLanguage, language, !oldLanguageESet));
	}
	...
	public void unsetLanguage() {
		...
		languageESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _4Package.STANDARD_METADATA_TYPE__LANGUAGE, oldLanguage, LANGUAGE_EDEFAULT, oldLanguageESet));
	}
	...
	public void setPublicationStatus(PublicationStatusType newPublicationStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _4Package.STANDARD_METADATA_TYPE__PUBLICATION_STATUS, oldPublicationStatus, publicationStatus, !oldPublicationStatusESet));
	}
	...
	public void unsetPublicationStatus() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _4Package.STANDARD_METADATA_TYPE__PUBLICATION_STATUS, oldPublicationStatus, PUBLICATION_STATUS_EDEFAULT, oldPublicationStatusESet));
	}
	...
	public void setReferenceDistributionOpts(ReferenceDistributionOptsType newReferenceDistributionOpts) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _4Package.STANDARD_METADATA_TYPE__REFERENCE_DISTRIBUTION_OPTS, oldReferenceDistributionOpts, referenceDistributionOpts, !oldReferenceDistributionOptsESet));
	}
	...
	public void unsetReferenceDistributionOpts() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _4Package.STANDARD_METADATA_TYPE__REFERENCE_DISTRIBUTION_OPTS, oldReferenceDistributionOpts, REFERENCE_DISTRIBUTION_OPTS_EDEFAULT, oldReferenceDistributionOptsESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _4Package.STANDARD_METADATA_TYPE__CONTRIBUTORS:
				return basicSetContributors(null, msgs);
			case _4Package.STANDARD_METADATA_TYPE__TITLES:
				return basicSetTitles(null, msgs);
			case _4Package.STANDARD_METADATA_TYPE__ABSTRACT:
				return ((InternalEList<?>)getAbstract()).basicRemove(otherEnd, msgs);
			case _4Package.STANDARD_METADATA_TYPE__DESIGNATORS:
				return basicSetDesignators(null, msgs);
			case _4Package.STANDARD_METADATA_TYPE__APPROVAL_DATE:
				return basicSetApprovalDate(null, msgs);
			case _4Package.STANDARD_METADATA_TYPE__ISBN:
				return ((InternalEList<?>)getIsbn()).basicRemove(otherEnd, msgs);
			case _4Package.STANDARD_METADATA_TYPE__PUBLISHER:
				return basicSetPublisher(null, msgs);
			case _4Package.STANDARD_METADATA_TYPE__STANDARDS_BODY:
				return basicSetStandardsBody(null, msgs);
			case _4Package.STANDARD_METADATA_TYPE__PUBLISHER_ITEM:
				return basicSetPublisherItem(null, msgs);
			case _4Package.STANDARD_METADATA_TYPE__CROSSMARK:
				return basicSetCrossmark(null, msgs);
			case _4Package.STANDARD_METADATA_TYPE__PROGRAM:
				return basicSetProgram(null, msgs);
			case _4Package.STANDARD_METADATA_TYPE__PROGRAM1:
				return basicSetProgram1(null, msgs);
			case _4Package.STANDARD_METADATA_TYPE__PROGRAM2:
				return basicSetProgram2(null, msgs);
			case _4Package.STANDARD_METADATA_TYPE__ARCHIVE_LOCATIONS:
				return basicSetArchiveLocations(null, msgs);
			case _4Package.STANDARD_METADATA_TYPE__DOI_DATA:
				return basicSetDoiData(null, msgs);
			case _4Package.STANDARD_METADATA_TYPE__CITATION_LIST:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case _4Package.STANDARD_METADATA_TYPE__EDITION_NUMBER:
			...
			case _4Package.STANDARD_METADATA_TYPE__LANGUAGE:
				return getLanguage();
			case _4Package.STANDARD_METADATA_TYPE__PUBLICATION_STATUS:
				return getPublicationStatus();
			case _4Package.STANDARD_METADATA_TYPE__REFERENCE_DISTRIBUTION_OPTS:
