 ...
 * </p>
 * <ul>
 *   <li>{@link org.crossref.schema._4._4.impl.UpdatesTypeImpl#getUpdate <em>Update</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UpdatesTypeImpl extends MinimalEObjectImpl.Container implements UpdatesType {
	/**
	...
	protected EClass eStaticClass() {
		return _4Package.eINSTANCE.getUpdatesType();
	}
	...
	public EList<UpdateType> getUpdate() {
		if (update == null) {
			update = new EObjectContainmentEList<UpdateType>(UpdateType.class, this, _4Package.UPDATES_TYPE__UPDATE);
		}
		return update;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _4Package.UPDATES_TYPE__UPDATE:
