 ...
 * </p>
 * <ul>
 *   <li>{@link org.crossref.schema._4._4.impl.DegreesTypeImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link org.crossref.schema._4._4.impl.DegreesTypeImpl#getContentType <em>Content Type</em>}</li>
 *   <li>{@link org.crossref.schema._4._4.impl.DegreesTypeImpl#getLanguage <em>Language</em>}</li>
 *   <li>{@link org.crossref.schema._4._4.impl.DegreesTypeImpl#getSpecificUse <em>Specific Use</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DegreesTypeImpl extends MinimalEObjectImpl.Container implements DegreesType {
	...
	protected EClass eStaticClass() {
		return _4Package.eINSTANCE.getDegreesType();
	}
	...
	public FeatureMap getMixed() {
		if (mixed == null) {
			mixed = new BasicFeatureMap(this, _4Package.DEGREES_TYPE__MIXED);
		}
		return mixed;
	}
	...
	public void setContentType(Object newContentType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _4Package.DEGREES_TYPE__CONTENT_TYPE, oldContentType, contentType));
	}
	...
	public void setLanguage(LanguageType newLanguage) {
		...
		languageESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _4Package.DEGREES_TYPE__LANGUAGE, oldLanguage, language, !oldLanguageESet));
	}
	...
	public void unsetLanguage() {
		...
		languageESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _4Package.DEGREES_TYPE__LANGUAGE, oldLanguage, LANGUAGE_EDEFAULT, oldLanguageESet));
	}
	...
	public void setSpecificUse(Object newSpecificUse) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _4Package.DEGREES_TYPE__SPECIFIC_USE, oldSpecificUse, specificUse));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _4Package.DEGREES_TYPE__MIXED:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case _4Package.DEGREES_TYPE__CONTENT_TYPE:
				return getContentType();
			case _4Package.DEGREES_TYPE__LANGUAGE:
				return getLanguage();
			case _4Package.DEGREES_TYPE__SPECIFIC_USE:
