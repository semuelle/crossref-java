 ...
 * </p>
 * <ul>
 *   <li>{@link org.crossref.schema._4._4.impl.IssnTypeImpl#getValue <em>Value</em>}</li>
 *   <li>{@link org.crossref.schema._4._4.impl.IssnTypeImpl#getMediaType <em>Media Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IssnTypeImpl extends MinimalEObjectImpl.Container implements IssnType {
	...
	protected EClass eStaticClass() {
		return _4Package.eINSTANCE.getIssnType();
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _4Package.ISSN_TYPE__VALUE, oldValue, value));
	}
	...
	public void setMediaType(MediaTypeType newMediaType) {
		...
		mediaTypeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _4Package.ISSN_TYPE__MEDIA_TYPE, oldMediaType, mediaType, !oldMediaTypeESet));
	}
	...
	public void unsetMediaType() {
		...
		mediaTypeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _4Package.ISSN_TYPE__MEDIA_TYPE, oldMediaType, MEDIA_TYPE_EDEFAULT, oldMediaTypeESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _4Package.ISSN_TYPE__VALUE:
				return getValue();
			case _4Package.ISSN_TYPE__MEDIA_TYPE:
				return getMediaType();
		}
