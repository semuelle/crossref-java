 ...
 * </p>
 * <ul>
 *   <li>{@link org.crossref.schema._4._4.impl.FormatTypeImpl#getValue <em>Value</em>}</li>
 *   <li>{@link org.crossref.schema._4._4.impl.FormatTypeImpl#getMimeType <em>Mime Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FormatTypeImpl extends MinimalEObjectImpl.Container implements FormatType {
	...
	protected EClass eStaticClass() {
		return _4Package.eINSTANCE.getFormatType();
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _4Package.FORMAT_TYPE__VALUE, oldValue, value));
	}
	...
	public void setMimeType(MimeTypeType newMimeType) {
		...
		mimeTypeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _4Package.FORMAT_TYPE__MIME_TYPE, oldMimeType, mimeType, !oldMimeTypeESet));
	}
	...
	public void unsetMimeType() {
		...
		mimeTypeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _4Package.FORMAT_TYPE__MIME_TYPE, oldMimeType, MIME_TYPE_EDEFAULT, oldMimeTypeESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _4Package.FORMAT_TYPE__VALUE:
				return getValue();
			case _4Package.FORMAT_TYPE__MIME_TYPE:
				return getMimeType();
		}
