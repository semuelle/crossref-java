 ...
 * <!-- end-user-doc -->
 * @see org.crossref.fundref.FundrefPackage#getProviderType()
 * @model extendedMetaData="name='provider_._type'"
 * @generated
 */
public enum ProviderType implements Enumerator {
	 ...
	 * @ordered
	 */
	PUBLISHER(0, "publisher", "publisher"),

	/**
	 * The '<em><b>Crossref</b></em>' literal object.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #CROSSREF_VALUE
	 * @generated
	...
	/**
	 * The '<em><b>Crossref</b></em>' literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #CROSSREF
	 * @model name="crossref"
	 ...
	 * @ordered
	 */
	public static final int CROSSREF_VALUE = 1;
	...
	public static ProviderType get(int value) {
		switch (value) {
			...
			case CROSSREF_VALUE: return CROSSREF;
		}
		return null;
	}
