...
public class RelationsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case RelationsPackage.INTER_WORK_RELATION_TYPE: {
				InterWorkRelationType interWorkRelationType = (InterWorkRelationType)theEObject;
				T result = caseInterWorkRelationType(interWorkRelationType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RelationsPackage.INTRA_WORK_RELATION_TYPE: {
				IntraWorkRelationType intraWorkRelationType = (IntraWorkRelationType)theEObject;
				T result = caseIntraWorkRelationType(intraWorkRelationType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case RelationsPackage.RELATED_ITEM_TYPE: {
				RelatedItemType relatedItemType = (RelatedItemType)theEObject;
				T result = caseRelatedItemType(relatedItemType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Inter Work Relation Type</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Inter Work Relation Type</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseInterWorkRelationType(InterWorkRelationType object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Intra Work Relation Type</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Intra Work Relation Type</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseIntraWorkRelationType(IntraWorkRelationType object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Related Item Type</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Related Item Type</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseRelatedItemType(RelatedItemType object) {
		return null;
	}
