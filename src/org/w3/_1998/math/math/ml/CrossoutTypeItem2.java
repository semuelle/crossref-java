...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Crossout Type Item2</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.w3._1998.math.math.ml.MlPackage#getCrossoutTypeItem2()
 * @model extendedMetaData="name='crossout_._type_._item'"
 * @generated
 */
public enum CrossoutTypeItem2 implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Crossout Type Item2</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final CrossoutTypeItem2[] VALUES_ARRAY =
		new CrossoutTypeItem2[] {
			NONE,
			UPDIAGONALSTRIKE,
			DOWNDIAGONALSTRIKE,
			VERTICALSTRIKE,
	...
	/**
	 * A public read-only list of all the '<em><b>Crossout Type Item2</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<CrossoutTypeItem2> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Crossout Type Item2</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static CrossoutTypeItem2 get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			CrossoutTypeItem2 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Crossout Type Item2</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static CrossoutTypeItem2 getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			CrossoutTypeItem2 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Crossout Type Item2</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static CrossoutTypeItem2 get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private CrossoutTypeItem2(int value, String name, String literal) {
		this.value = value;
		this.name = name;
