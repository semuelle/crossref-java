...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Longdivstyle Type</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.w3._1998.math.math.ml.MlPackage#getLongdivstyleType()
 * @model extendedMetaData="name='longdivstyle_._1_._type'"
 * @generated
 */
public enum LongdivstyleType implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Longdivstyle Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final LongdivstyleType[] VALUES_ARRAY =
		new LongdivstyleType[] {
			LEFTTOP,
			STACKEDRIGHTRIGHT,
	...
	/**
	 * A public read-only list of all the '<em><b>Longdivstyle Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<LongdivstyleType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Longdivstyle Type</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static LongdivstyleType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			LongdivstyleType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Longdivstyle Type</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static LongdivstyleType getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			LongdivstyleType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Longdivstyle Type</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static LongdivstyleType get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private LongdivstyleType(int value, String name, String literal) {
		this.value = value;
		this.name = name;
