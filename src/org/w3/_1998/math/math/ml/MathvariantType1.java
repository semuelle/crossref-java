...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Mathvariant Type1</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.w3._1998.math.math.ml.MlPackage#getMathvariantType1()
 * @model extendedMetaData="name='mathvariant_._2_._type'"
 * @generated
 */
public enum MathvariantType1 implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Mathvariant Type1</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final MathvariantType1[] VALUES_ARRAY =
		new MathvariantType1[] {
			NORMAL,
			BOLD,
			ITALIC,
			BOLD_ITALIC,
	...
	/**
	 * A public read-only list of all the '<em><b>Mathvariant Type1</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<MathvariantType1> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Mathvariant Type1</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static MathvariantType1 get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			MathvariantType1 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Mathvariant Type1</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static MathvariantType1 getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			MathvariantType1 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Mathvariant Type1</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static MathvariantType1 get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private MathvariantType1(int value, String name, String literal) {
		this.value = value;
		this.name = name;
