...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Mtr Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MtrTypeImpl#getTableCellExpressionGroup <em>Table Cell Expression Group</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MtrTypeImpl#getTableCellExpression <em>Table Cell Expression</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MtrTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MtrTypeImpl#getColumnalign <em>Columnalign</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MtrTypeImpl#getGroupalign <em>Groupalign</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MtrTypeImpl#getHref <em>Href</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MtrTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MtrTypeImpl#getMathbackground <em>Mathbackground</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MtrTypeImpl#getMathcolor <em>Mathcolor</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MtrTypeImpl#getOther <em>Other</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MtrTypeImpl#getRowalign <em>Rowalign</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MtrTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MtrTypeImpl#getXref <em>Xref</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MtrTypeImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MtrTypeImpl extends MinimalEObjectImpl.Container implements MtrType {
	/**
	...
	protected EClass eStaticClass() {
		return MlPackage.eINSTANCE.getMtrType();
	}
	...
	public FeatureMap getTableCellExpressionGroup() {
		if (tableCellExpressionGroup == null) {
			tableCellExpressionGroup = new BasicFeatureMap(this, MlPackage.MTR_TYPE__TABLE_CELL_EXPRESSION_GROUP);
		}
	...
	public EList<TableCellExpressionType> getTableCellExpression() {
		return getTableCellExpressionGroup().list(MlPackage.eINSTANCE.getMtrType_TableCellExpression());
	}
	...
	public void setClass(List<String> newClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MlPackage.MTR_TYPE__CLASS, oldClass, class_));
	}
	...
	public void setColumnalign(List<Columnalignstyle> newColumnalign) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MlPackage.MTR_TYPE__COLUMNALIGN, oldColumnalign, columnalign));
	}
	...
	public void setGroupalign(String newGroupalign) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MlPackage.MTR_TYPE__GROUPALIGN, oldGroupalign, groupalign));
	}
	...
	public void setHref(String newHref) {
		...
		href = newHref;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MlPackage.MTR_TYPE__HREF, oldHref, href));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MlPackage.MTR_TYPE__ID, oldId, id));
	}
	...
	public void setMathbackground(Object newMathbackground) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MlPackage.MTR_TYPE__MATHBACKGROUND, oldMathbackground, mathbackground));
	}
	...
	public void setMathcolor(String newMathcolor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MlPackage.MTR_TYPE__MATHCOLOR, oldMathcolor, mathcolor));
	}
	...
	public void setOther(Object newOther) {
		...
		other = newOther;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MlPackage.MTR_TYPE__OTHER, oldOther, other));
	}
	...
	public void setRowalign(RowalignType newRowalign) {
		...
		rowalignESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MlPackage.MTR_TYPE__ROWALIGN, oldRowalign, rowalign, !oldRowalignESet));
	}
	...
	public void unsetRowalign() {
		...
		rowalignESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, MlPackage.MTR_TYPE__ROWALIGN, oldRowalign, ROWALIGN_EDEFAULT, oldRowalignESet));
	}
	...
	public void setStyle(String newStyle) {
		...
		style = newStyle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MlPackage.MTR_TYPE__STYLE, oldStyle, style));
	}
	...
	public void setXref(Object newXref) {
		...
		xref = newXref;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MlPackage.MTR_TYPE__XREF, oldXref, xref));
	}
	...
	public FeatureMap getAnyAttribute() {
		if (anyAttribute == null) {
			anyAttribute = new BasicFeatureMap(this, MlPackage.MTR_TYPE__ANY_ATTRIBUTE);
		}
		return anyAttribute;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case MlPackage.MTR_TYPE__CLASS:
				return getClass_();
			case MlPackage.MTR_TYPE__COLUMNALIGN:
				return getColumnalign();
			case MlPackage.MTR_TYPE__GROUPALIGN:
				return getGroupalign();
			case MlPackage.MTR_TYPE__HREF:
				return getHref();
			case MlPackage.MTR_TYPE__ID:
				return getId();
			case MlPackage.MTR_TYPE__MATHBACKGROUND:
				return getMathbackground();
			case MlPackage.MTR_TYPE__MATHCOLOR:
				return getMathcolor();
			case MlPackage.MTR_TYPE__OTHER:
				return getOther();
			case MlPackage.MTR_TYPE__ROWALIGN:
				return getRowalign();
			case MlPackage.MTR_TYPE__STYLE:
				return getStyle();
			case MlPackage.MTR_TYPE__XREF:
				return getXref();
			case MlPackage.MTR_TYPE__ANY_ATTRIBUTE:
