...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Menclose Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MencloseTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MencloseTypeImpl#getHref <em>Href</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MencloseTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MencloseTypeImpl#getMathbackground <em>Mathbackground</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MencloseTypeImpl#getMathcolor <em>Mathcolor</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MencloseTypeImpl#getNotation <em>Notation</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MencloseTypeImpl#getOther <em>Other</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MencloseTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MencloseTypeImpl#getXref <em>Xref</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MencloseTypeImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MencloseTypeImpl extends ImpliedMrowImpl implements MencloseType {
	/**
	...
	protected EClass eStaticClass() {
		return MlPackage.eINSTANCE.getMencloseType();
	}
	...
	public void setClass(List<String> newClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MlPackage.MENCLOSE_TYPE__CLASS, oldClass, class_));
	}
	...
	public void setHref(String newHref) {
		...
		href = newHref;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MlPackage.MENCLOSE_TYPE__HREF, oldHref, href));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MlPackage.MENCLOSE_TYPE__ID, oldId, id));
	}
	...
	public void setMathbackground(Object newMathbackground) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MlPackage.MENCLOSE_TYPE__MATHBACKGROUND, oldMathbackground, mathbackground));
	}
	...
	public void setMathcolor(String newMathcolor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MlPackage.MENCLOSE_TYPE__MATHCOLOR, oldMathcolor, mathcolor));
	}
	...
	public void setNotation(Object newNotation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MlPackage.MENCLOSE_TYPE__NOTATION, oldNotation, notation));
	}
	...
	public void setOther(Object newOther) {
		...
		other = newOther;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MlPackage.MENCLOSE_TYPE__OTHER, oldOther, other));
	}
	...
	public void setStyle(String newStyle) {
		...
		style = newStyle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MlPackage.MENCLOSE_TYPE__STYLE, oldStyle, style));
	}
	...
	public void setXref(Object newXref) {
		...
		xref = newXref;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MlPackage.MENCLOSE_TYPE__XREF, oldXref, xref));
	}
	...
	public FeatureMap getAnyAttribute() {
		if (anyAttribute == null) {
			anyAttribute = new BasicFeatureMap(this, MlPackage.MENCLOSE_TYPE__ANY_ATTRIBUTE);
		}
		return anyAttribute;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MlPackage.MENCLOSE_TYPE__ANY_ATTRIBUTE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MlPackage.MENCLOSE_TYPE__CLASS:
				return getClass_();
			case MlPackage.MENCLOSE_TYPE__HREF:
				return getHref();
			case MlPackage.MENCLOSE_TYPE__ID:
				return getId();
			case MlPackage.MENCLOSE_TYPE__MATHBACKGROUND:
				return getMathbackground();
			case MlPackage.MENCLOSE_TYPE__MATHCOLOR:
				return getMathcolor();
			case MlPackage.MENCLOSE_TYPE__NOTATION:
				return getNotation();
			case MlPackage.MENCLOSE_TYPE__OTHER:
				return getOther();
			case MlPackage.MENCLOSE_TYPE__STYLE:
				return getStyle();
			case MlPackage.MENCLOSE_TYPE__XREF:
				return getXref();
			case MlPackage.MENCLOSE_TYPE__ANY_ATTRIBUTE:
