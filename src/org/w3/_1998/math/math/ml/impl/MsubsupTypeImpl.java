...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Msubsup Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MsubsupTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MsubsupTypeImpl#getHref <em>Href</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MsubsupTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MsubsupTypeImpl#getMathbackground <em>Mathbackground</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MsubsupTypeImpl#getMathcolor <em>Mathcolor</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MsubsupTypeImpl#getOther <em>Other</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MsubsupTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MsubsupTypeImpl#getSubscriptshift <em>Subscriptshift</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MsubsupTypeImpl#getSuperscriptshift <em>Superscriptshift</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MsubsupTypeImpl#getXref <em>Xref</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MsubsupTypeImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MsubsupTypeImpl extends MinimalEObjectImpl.Container implements MsubsupType {
	/**
	...
	protected EClass eStaticClass() {
		return MlPackage.eINSTANCE.getMsubsupType();
	}
	...
	public void setClass(List<String> newClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MlPackage.MSUBSUP_TYPE__CLASS, oldClass, class_));
	}
	...
	public void setHref(String newHref) {
		...
		href = newHref;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MlPackage.MSUBSUP_TYPE__HREF, oldHref, href));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MlPackage.MSUBSUP_TYPE__ID, oldId, id));
	}
	...
	public void setMathbackground(Object newMathbackground) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MlPackage.MSUBSUP_TYPE__MATHBACKGROUND, oldMathbackground, mathbackground));
	}
	...
	public void setMathcolor(String newMathcolor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MlPackage.MSUBSUP_TYPE__MATHCOLOR, oldMathcolor, mathcolor));
	}
	...
	public void setOther(Object newOther) {
		...
		other = newOther;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MlPackage.MSUBSUP_TYPE__OTHER, oldOther, other));
	}
	...
	public void setStyle(String newStyle) {
		...
		style = newStyle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MlPackage.MSUBSUP_TYPE__STYLE, oldStyle, style));
	}
	...
	public void setSubscriptshift(String newSubscriptshift) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MlPackage.MSUBSUP_TYPE__SUBSCRIPTSHIFT, oldSubscriptshift, subscriptshift));
	}
	...
	public void setSuperscriptshift(String newSuperscriptshift) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MlPackage.MSUBSUP_TYPE__SUPERSCRIPTSHIFT, oldSuperscriptshift, superscriptshift));
	}
	...
	public void setXref(Object newXref) {
		...
		xref = newXref;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MlPackage.MSUBSUP_TYPE__XREF, oldXref, xref));
	}
	...
	public FeatureMap getAnyAttribute() {
		if (anyAttribute == null) {
			anyAttribute = new BasicFeatureMap(this, MlPackage.MSUBSUP_TYPE__ANY_ATTRIBUTE);
		}
		return anyAttribute;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MlPackage.MSUBSUP_TYPE__ANY_ATTRIBUTE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MlPackage.MSUBSUP_TYPE__CLASS:
				return getClass_();
			case MlPackage.MSUBSUP_TYPE__HREF:
				return getHref();
			case MlPackage.MSUBSUP_TYPE__ID:
				return getId();
			case MlPackage.MSUBSUP_TYPE__MATHBACKGROUND:
				return getMathbackground();
			case MlPackage.MSUBSUP_TYPE__MATHCOLOR:
				return getMathcolor();
			case MlPackage.MSUBSUP_TYPE__OTHER:
				return getOther();
			case MlPackage.MSUBSUP_TYPE__STYLE:
				return getStyle();
			case MlPackage.MSUBSUP_TYPE__SUBSCRIPTSHIFT:
				return getSubscriptshift();
			case MlPackage.MSUBSUP_TYPE__SUPERSCRIPTSHIFT:
				return getSuperscriptshift();
			case MlPackage.MSUBSUP_TYPE__XREF:
				return getXref();
			case MlPackage.MSUBSUP_TYPE__ANY_ATTRIBUTE:
