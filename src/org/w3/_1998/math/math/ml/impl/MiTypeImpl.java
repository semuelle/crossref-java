...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Mi Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MiTypeImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MiTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MiTypeImpl#getMglyph <em>Mglyph</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MiTypeImpl#getMalignmark <em>Malignmark</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MiTypeImpl#getBackground <em>Background</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MiTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MiTypeImpl#getColor <em>Color</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MiTypeImpl#getDir <em>Dir</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MiTypeImpl#getFontfamily <em>Fontfamily</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MiTypeImpl#getFontsize <em>Fontsize</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MiTypeImpl#getFontstyle <em>Fontstyle</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MiTypeImpl#getFontweight <em>Fontweight</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MiTypeImpl#getHref <em>Href</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MiTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MiTypeImpl#getMathbackground <em>Mathbackground</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MiTypeImpl#getMathcolor <em>Mathcolor</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MiTypeImpl#getMathsize <em>Mathsize</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MiTypeImpl#getMathvariant <em>Mathvariant</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MiTypeImpl#getOther <em>Other</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MiTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MiTypeImpl#getXref <em>Xref</em>}</li>
 *   <li>{@link org.w3._1998.math.math.ml.impl.MiTypeImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MiTypeImpl extends MinimalEObjectImpl.Container implements MiType {
	/**
	...
	protected EClass eStaticClass() {
		return MlPackage.eINSTANCE.getMiType();
	}
	...
	public FeatureMap getMixed() {
		if (mixed == null) {
			mixed = new BasicFeatureMap(this, MlPackage.MI_TYPE__MIXED);
		}
		return mixed;
	}
	...
	public FeatureMap getGroup() {
		return (FeatureMap)getMixed().<FeatureMap.Entry>list(MlPackage.eINSTANCE.getMiType_Group());
	}
	...
	public EList<MglyphType> getMglyph() {
		return getGroup().list(MlPackage.eINSTANCE.getMiType_Mglyph());
	}
	...
	public EList<MalignmarkType> getMalignmark() {
		return getGroup().list(MlPackage.eINSTANCE.getMiType_Malignmark());
	}
	...
	public void setBackground(Object newBackground) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MlPackage.MI_TYPE__BACKGROUND, oldBackground, background));
	}
	...
	public void setClass(List<String> newClass) {
		...
		class_ = newClass;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MlPackage.MI_TYPE__CLASS, oldClass, class_));
	}
	...
	public void setColor(String newColor) {
		...
		color = newColor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MlPackage.MI_TYPE__COLOR, oldColor, color));
	}
	...
	public void setDir(DirType1 newDir) {
		...
		dirESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MlPackage.MI_TYPE__DIR, oldDir, dir, !oldDirESet));
	}
	...
	public void unsetDir() {
		...
		dirESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, MlPackage.MI_TYPE__DIR, oldDir, DIR_EDEFAULT, oldDirESet));
	}
	...
	public void setFontfamily(Object newFontfamily) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MlPackage.MI_TYPE__FONTFAMILY, oldFontfamily, fontfamily));
	}
	...
	public void setFontsize(String newFontsize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MlPackage.MI_TYPE__FONTSIZE, oldFontsize, fontsize));
	}
	...
	public void setFontstyle(FontstyleType newFontstyle) {
		...
		fontstyleESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MlPackage.MI_TYPE__FONTSTYLE, oldFontstyle, fontstyle, !oldFontstyleESet));
	}
	...
	public void unsetFontstyle() {
		...
		fontstyleESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, MlPackage.MI_TYPE__FONTSTYLE, oldFontstyle, FONTSTYLE_EDEFAULT, oldFontstyleESet));
	}
	...
	public void setFontweight(FontweightType newFontweight) {
		...
		fontweightESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MlPackage.MI_TYPE__FONTWEIGHT, oldFontweight, fontweight, !oldFontweightESet));
	}
	...
	public void unsetFontweight() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, MlPackage.MI_TYPE__FONTWEIGHT, oldFontweight, FONTWEIGHT_EDEFAULT, oldFontweightESet));
	}
	...
	public void setHref(String newHref) {
		...
		href = newHref;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MlPackage.MI_TYPE__HREF, oldHref, href));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MlPackage.MI_TYPE__ID, oldId, id));
	}
	...
	public void setMathbackground(Object newMathbackground) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MlPackage.MI_TYPE__MATHBACKGROUND, oldMathbackground, mathbackground));
	}
	...
	public void setMathcolor(String newMathcolor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MlPackage.MI_TYPE__MATHCOLOR, oldMathcolor, mathcolor));
	}
	...
	public void setMathsize(Object newMathsize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MlPackage.MI_TYPE__MATHSIZE, oldMathsize, mathsize));
	}
	...
	public void setMathvariant(MathvariantType newMathvariant) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MlPackage.MI_TYPE__MATHVARIANT, oldMathvariant, mathvariant, !oldMathvariantESet));
	}
	...
	public void unsetMathvariant() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, MlPackage.MI_TYPE__MATHVARIANT, oldMathvariant, MATHVARIANT_EDEFAULT, oldMathvariantESet));
	}
	...
	public void setOther(Object newOther) {
		...
		other = newOther;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MlPackage.MI_TYPE__OTHER, oldOther, other));
	}
	...
	public void setStyle(String newStyle) {
		...
		style = newStyle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MlPackage.MI_TYPE__STYLE, oldStyle, style));
	}
	...
	public void setXref(Object newXref) {
		...
		xref = newXref;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MlPackage.MI_TYPE__XREF, oldXref, xref));
	}
	...
	public FeatureMap getAnyAttribute() {
		if (anyAttribute == null) {
			anyAttribute = new BasicFeatureMap(this, MlPackage.MI_TYPE__ANY_ATTRIBUTE);
		}
		return anyAttribute;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MlPackage.MI_TYPE__MIXED:
				return ((InternalEList<?>)getMixed()).basicRemove(otherEnd, msgs);
			case MlPackage.MI_TYPE__GROUP:
				return ((InternalEList<?>)getGroup()).basicRemove(otherEnd, msgs);
			case MlPackage.MI_TYPE__MGLYPH:
				return ((InternalEList<?>)getMglyph()).basicRemove(otherEnd, msgs);
			case MlPackage.MI_TYPE__MALIGNMARK:
				return ((InternalEList<?>)getMalignmark()).basicRemove(otherEnd, msgs);
			case MlPackage.MI_TYPE__ANY_ATTRIBUTE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case MlPackage.MI_TYPE__BACKGROUND:
				return getBackground();
			case MlPackage.MI_TYPE__CLASS:
				return getClass_();
			case MlPackage.MI_TYPE__COLOR:
				return getColor();
			case MlPackage.MI_TYPE__DIR:
				return getDir();
			case MlPackage.MI_TYPE__FONTFAMILY:
				return getFontfamily();
			case MlPackage.MI_TYPE__FONTSIZE:
				return getFontsize();
			case MlPackage.MI_TYPE__FONTSTYLE:
				return getFontstyle();
			case MlPackage.MI_TYPE__FONTWEIGHT:
				return getFontweight();
			case MlPackage.MI_TYPE__HREF:
				return getHref();
			case MlPackage.MI_TYPE__ID:
				return getId();
			case MlPackage.MI_TYPE__MATHBACKGROUND:
				return getMathbackground();
			case MlPackage.MI_TYPE__MATHCOLOR:
				return getMathcolor();
			case MlPackage.MI_TYPE__MATHSIZE:
				return getMathsize();
			case MlPackage.MI_TYPE__MATHVARIANT:
				return getMathvariant();
			case MlPackage.MI_TYPE__OTHER:
				return getOther();
			case MlPackage.MI_TYPE__STYLE:
				return getStyle();
			case MlPackage.MI_TYPE__XREF:
				return getXref();
			case MlPackage.MI_TYPE__ANY_ATTRIBUTE:
