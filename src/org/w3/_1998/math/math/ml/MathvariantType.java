...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Mathvariant Type</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.w3._1998.math.math.ml.MlPackage#getMathvariantType()
 * @model extendedMetaData="name='mathvariant_._1_._type'"
 * @generated
 */
public enum MathvariantType implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Mathvariant Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final MathvariantType[] VALUES_ARRAY =
		new MathvariantType[] {
			NORMAL,
			BOLD,
			ITALIC,
	...
	/**
	 * A public read-only list of all the '<em><b>Mathvariant Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<MathvariantType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Mathvariant Type</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static MathvariantType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			MathvariantType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Mathvariant Type</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static MathvariantType getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			MathvariantType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Mathvariant Type</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static MathvariantType get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private MathvariantType(int value, String name, String literal) {
		this.value = value;
		this.name = name;
